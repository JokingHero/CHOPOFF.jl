...
precompile(Tuple{Type{Transducers.Completing{typeof(Base.:(+))}}, Function})
precompile(Tuple{typeof(Base.haskey), NamedTuple{(:init,), Tuple{InitialValues.InitialValueOf{typeof(Base.:(+))}}}, Symbol})
...
precompile(Tuple{Type{NamedTuple{(:rev, :by), T} where T<:Tuple}, Tuple{Bool, ARTEMIS.var"#174#209"}})
...
precompile(Tuple{typeof(Base.grow_to!), Base.Dict{Symbol, Any}, Tuple{Pair{Symbol, String}, Pair{Symbol, DataType}, Pair{Symbol, ARTEMIS.var"#244#245"}, Pair{Symbol, String}}, Int64})
precompile(Tuple{Type{NamedTuple{(:default, :help, :arg_type, :range_tester), T} where T<:Tuple}, Tuple{String, String, DataType, ARTEMIS.var"#244#245"}})
precompile(Tuple{typeof(Base.merge), NamedTuple{(), Tuple{}}, NamedTuple{(:default, :help, :arg_type, :range_tester), Tuple{String, String, DataType, ARTEMIS.var"#244#245"}}})
precompile(Tuple{typeof(Base.isempty), NamedTuple{(:default, :help, :arg_type, :range_tester), Tuple{String, String, DataType, ARTEMIS.var"#244#245"}}})
precompile(Tuple{typeof(Base.pairs), NamedTuple{(:default, :help, :arg_type, :range_tester), Tuple{String, String, DataType, ARTEMIS.var"#244#245"}}})
precompile(Tuple{typeof(Base.keys), Base.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:default, :help, :arg_type, :range_tester), Tuple{String, String, DataType, ARTEMIS.var"#244#245"}}}})
precompile(Tuple{Type{Base.Dict{Symbol, Any}}, Base.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:default, :help, :arg_type, :range_tester), Tuple{String, String, DataType, ARTEMIS.var"#244#245"}}}})
precompile(Tuple{ARTEMIS.var"#244#245", String})
...
precompile(Tuple{Type{Tables.Schema{(:D0, :D1, :guide), Tuple{Int64, Int64, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}}}})
precompile(Tuple{typeof(Base.isvarargtype), Any})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, Tables.var"#11#12"{Tuple{Int64, Int64, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}}, Base.UnitRange{Int64}})
precompile(Tuple{typeof(Base.Iterators.rest), Base.Generator{Base.UnitRange{Int64}, Tables.var"#11#12"{Tuple{Int64, Int64, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}}}})
precompile(Tuple{typeof(Base._similar_shape), Base.Generator{Base.UnitRange{Int64}, Tables.var"#11#12"{Tuple{Int64, Int64, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}}}, Base.HasShape{1}})
precompile(Tuple{typeof(Base.iterate), Base.Generator{Base.UnitRange{Int64}, Tables.var"#11#12"{Tuple{Int64, Int64, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}}}})
...
precompile(Tuple{CSV.var"#103#104"{Bool, Bool, Tables.Schema{(:D0, :D1, :guide), Tuple{Int64, Int64, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}}, DataFrames.DataFrameRows{DataFrames.DataFrame}, CSV.Options{UInt8, UInt8, Nothing, Tuple{}, typeof(CSV._identity)}, Array{UInt8, 1}, Int64, Int64, Tuple{Symbol, Symbol, Symbol}}, Base.IOStream})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#159#162"{Base.UnitRange{Int64}}, Array{Base.UnitRange{Int64}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{Base.UnitRange{Int64}, 1}, Base.Generator{Array{Base.UnitRange{Int64}, 1}, ARTEMIS.var"#159#162"{Base.UnitRange{Int64}}}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#165#166"{ARTEMIS.VcfDB}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, ARTEMIS.var"#165#166"{ARTEMIS.VcfDB}}})
precompile(Tuple{typeof(Base._similar_for), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Type{Base.BitArray{1}}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, ARTEMIS.var"#165#166"{ARTEMIS.VcfDB}}, Base.HasShape{1}, Tuple{Base.OneTo{Int64}}})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Base.BitArray{1}, 1}, Base.BitArray{1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, ARTEMIS.var"#165#166"{ARTEMIS.VcfDB}}, Int64})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, ARTEMIS.var"#137#138"{String, String, Int64, ARTEMIS.LinearDB}})
precompile(Tuple{Type{NamedTuple{(:init, :basesize), T} where T<:Tuple}, Tuple{InitialValues.InitialValueOf{typeof(Base.:(+))}, Int64}})
precompile(Tuple{Type{Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, Function})
precompile(Tuple{typeof(Transducers.initialize), InitialValues.InitialValueOf{typeof(Base.:(+))}, Function})
precompile(Tuple{typeof(Transducers.start), Function, InitialValues.InitialValueOf{typeof(Base.:(+))}})
precompile(Tuple{typeof(Transducers.completebasecase), Function, InitialValues.InitialValueOf{typeof(Base.:(+))}})
precompile(Tuple{Transducers.var"#foldxt##kw", NamedTuple{(:init, :basesize), Tuple{InitialValues.InitialValueOf{typeof(Base.:(+))}, Int64}}, typeof(Transducers.foldxt), typeof(Base.:(+)), Transducers.Map{ARTEMIS.var"#137#138"{String, String, Int64, ARTEMIS.LinearDB}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{Transducers.var"#167#168"{Transducers.Reduction{Transducers.Map{ARTEMIS.var"#137#138"{String, String, Int64, ARTEMIS.LinearDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, InitialValues.InitialValueOf{typeof(Base.:(+))}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
...
precompile(Tuple{typeof(ARTEMIS.decode), ARTEMIS.Loc{UInt8, UInt32}, ARTEMIS.DBInfo})
precompile(Tuple{typeof(Base.iterate), Array{ARTEMIS.Loc{T, K} where K<:Unsigned where T<:Unsigned, 1}, Int64})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#137#138"{String, String, Int64, ARTEMIS.LinearDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, Array{Int64, 2}, Array{Int64, 2}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#137#138"{String, String, Int64, ARTEMIS.LinearDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, Array{Int64, 2}})
...
precompile(Tuple{DataFrames.var"#120#121", Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.promote_type), Type{Int64}, Type{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, ARTEMIS.var"#148#149"{String, String, Int64, ARTEMIS.TreeDB}})
precompile(Tuple{Transducers.var"#foldxt##kw", NamedTuple{(:init, :basesize), Tuple{InitialValues.InitialValueOf{typeof(Base.:(+))}, Int64}}, typeof(Transducers.foldxt), typeof(Base.:(+)), Transducers.Map{ARTEMIS.var"#148#149"{String, String, Int64, ARTEMIS.TreeDB}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{Transducers.var"#167#168"{Transducers.Reduction{Transducers.Map{ARTEMIS.var"#148#149"{String, String, Int64, ARTEMIS.TreeDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, InitialValues.InitialValueOf{typeof(Base.:(+))}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{Transducers.var"#167#168"{Transducers.Reduction{Transducers.Map{ARTEMIS.var"#148#149"{String, String, Int64, ARTEMIS.TreeDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, InitialValues.InitialValueOf{typeof(Base.:(+))}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{Transducers.var"#167#168"{Transducers.Reduction{Transducers.Map{ARTEMIS.var"#148#149"{String, String, Int64, ARTEMIS.TreeDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, InitialValues.InitialValueOf{typeof(Base.:(+))}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{Transducers.var"#167#168"{Transducers.Reduction{Transducers.Map{ARTEMIS.var"#148#149"{String, String, Int64, ARTEMIS.TreeDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, InitialValues.InitialValueOf{typeof(Base.:(+))}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{Transducers.var"#167#168"{Transducers.Reduction{Transducers.Map{ARTEMIS.var"#148#149"{String, String, Int64, ARTEMIS.TreeDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, InitialValues.InitialValueOf{typeof(Base.:(+))}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
...
precompile(Tuple{typeof(Base.:(>)), Int64, UInt8})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#148#149"{String, String, Int64, ARTEMIS.TreeDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, Array{Int64, 2}, Array{Int64, 2}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#148#149"{String, String, Int64, ARTEMIS.TreeDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, Array{Int64, 2}})
...
precompile(Tuple{typeof(DataAPI.refpool), Array{InlineStrings.String31, 1}})
...
precompile(Tuple{Main.var"#mutate_suffix!#3", BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, Main.var"#4#6", Combinatorics.MultiSetPermutations{Array{Char, 1}}})
...
precompile(Tuple{typeof(Base.collect), Base.Generator{Combinatorics.MultiSetPermutations{Array{Char, 1}}, Main.var"#4#6"}})
precompile(Tuple{typeof(Base.rand), Array{String, 1}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, Main.var"#5#7"{String}, Array{String, 1}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Array{String, 1}, Main.var"#5#7"{String}}})
precompile(Tuple{typeof(Base.Broadcast.materialize), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(==)), Tuple{Array{Int64, 1}, Int64}}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, Main.var"#8#14"{UInt64}, Array{UInt64, 1}})
precompile(Tuple{typeof(Base._simple_count_helper), Base.Generator{Array{UInt64, 1}, Main.var"#8#14"{UInt64}}, Int64})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, Main.var"#9#15"{UInt8}, Array{UInt8, 1}})
precompile(Tuple{typeof(Base._simple_count_helper), Base.Generator{Array{UInt8, 1}, Main.var"#9#15"{UInt8}}, Int64})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, Main.var"#10#16"{UInt32}, Array{UInt32, 1}})
precompile(Tuple{typeof(Base._simple_count_helper), Base.Generator{Array{UInt32, 1}, Main.var"#10#16"{UInt32}}, Int64})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, Main.var"#11#17"{UInt8}, Array{UInt8, 1}})
precompile(Tuple{typeof(Base._simple_count_helper), Base.Generator{Array{UInt8, 1}, Main.var"#11#17"{UInt8}}, Int64})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, Main.var"#13#19"{UInt8}, Array{UInt8, 1}})
precompile(Tuple{typeof(Base._simple_count_helper), Base.Generator{Array{UInt8, 1}, Main.var"#13#19"{UInt8}}, Int64})
