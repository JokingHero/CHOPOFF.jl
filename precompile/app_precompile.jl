...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#143#144"{String, Int64, TwoBit.Reader{Base.IOStream}, ARTEMIS.DBInfo}, Array{String, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{String, 1}, Base.Generator{Array{String, 1}, ARTEMIS.var"#143#144"{String, Int64, TwoBit.Reader{Base.IOStream}, ARTEMIS.DBInfo}}})
precompile(Tuple{typeof(Base._similar_for), Array{String, 1}, Type{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}}, Base.Generator{Array{String, 1}, ARTEMIS.var"#143#144"{String, Int64, TwoBit.Reader{Base.IOStream}, ARTEMIS.DBInfo}}, Base.HasShape{1}, Tuple{Base.OneTo{Int64}}})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{String, 1}, ARTEMIS.var"#143#144"{String, Int64, TwoBit.Reader{Base.IOStream}, ARTEMIS.DBInfo}}, Int64})
