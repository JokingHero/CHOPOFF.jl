...
precompile(Tuple{typeof(Base.grow_to!), Base.Dict{Symbol, Any}, Tuple{Pair{Symbol, String}, Pair{Symbol, DataType}, Pair{Symbol, ARTEMIS.var"#251#253"}, Pair{Symbol, String}}, Int64})
precompile(Tuple{Type{NamedTuple{(:default, :help, :arg_type, :range_tester), T} where T<:Tuple}, Tuple{String, String, DataType, ARTEMIS.var"#251#253"}})
precompile(Tuple{typeof(Base.merge), NamedTuple{(), Tuple{}}, NamedTuple{(:default, :help, :arg_type, :range_tester), Tuple{String, String, DataType, ARTEMIS.var"#251#253"}}})
precompile(Tuple{typeof(Base.pairs), NamedTuple{(:default, :help, :arg_type, :range_tester), Tuple{String, String, DataType, ARTEMIS.var"#251#253"}}})
precompile(Tuple{typeof(Base.keys), Base.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:default, :help, :arg_type, :range_tester), Tuple{String, String, DataType, ARTEMIS.var"#251#253"}}}})
precompile(Tuple{Type{Base.Dict{Symbol, Any}}, Base.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:default, :help, :arg_type, :range_tester), Tuple{String, String, DataType, ARTEMIS.var"#251#253"}}}})
precompile(Tuple{ARTEMIS.var"#251#253", String})
...
precompile(Tuple{typeof(Base.grow_to!), Base.Dict{Symbol, Any}, Tuple{Pair{Symbol, String}, Pair{Symbol, DataType}, Pair{Symbol, ARTEMIS.var"#252#254"}, Pair{Symbol, Bool}}, Int64})
precompile(Tuple{Type{NamedTuple{(:help, :arg_type, :required, :range_tester), T} where T<:Tuple}, Tuple{String, DataType, Bool, ARTEMIS.var"#252#254"}})
precompile(Tuple{typeof(Base.merge), NamedTuple{(), Tuple{}}, NamedTuple{(:help, :arg_type, :required, :range_tester), Tuple{String, DataType, Bool, ARTEMIS.var"#252#254"}}})
precompile(Tuple{typeof(Base.pairs), NamedTuple{(:help, :arg_type, :required, :range_tester), Tuple{String, DataType, Bool, ARTEMIS.var"#252#254"}}})
precompile(Tuple{typeof(Base.keys), Base.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:help, :arg_type, :required, :range_tester), Tuple{String, DataType, Bool, ARTEMIS.var"#252#254"}}}})
precompile(Tuple{Type{Base.Dict{Symbol, Any}}, Base.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:help, :arg_type, :required, :range_tester), Tuple{String, DataType, Bool, ARTEMIS.var"#252#254"}}}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#37#40"{Array{Int64, 1}}, Array{PathDistribution.PathEnum, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{PathDistribution.PathEnum, 1}, Base.Generator{Array{PathDistribution.PathEnum, 1}, ARTEMIS.var"#37#40"{Array{Int64, 1}}}})
...
precompile(Tuple{typeof(Base._similar_for), Array{PathDistribution.PathEnum, 1}, Type{Array{Int64, 1}}, Base.Generator{Array{PathDistribution.PathEnum, 1}, ARTEMIS.var"#37#40"{Array{Int64, 1}}}, Base.HasShape{1}, Tuple{Base.OneTo{Int64}}})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Array{Int64, 1}, 1}, Array{Int64, 1}, Base.Generator{Array{PathDistribution.PathEnum, 1}, ARTEMIS.var"#37#40"{Array{Int64, 1}}}, Int64})
precompile(Tuple{typeof(Base.map), Function, Array{Array{Int64, 1}, 1}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#38#41"{Array{Int64, 1}}, Array{Array{Int64, 1}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{Array{Int64, 1}, 1}, Base.Generator{Array{Array{Int64, 1}, 1}, ARTEMIS.var"#38#41"{Array{Int64, 1}}}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#39#42"{Int64}, Array{Array{Int64, 1}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{Array{Int64, 1}, 1}, Base.Generator{Array{Array{Int64, 1}, 1}, ARTEMIS.var"#39#42"{Int64}}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, ARTEMIS.var"#58#59"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{ARTEMIS.var"#58#59"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}}, Array{Base.UnitRange{Int64}, 1}})
precompile(Tuple{Transducers.var"#167#168"{Transducers.Reduction{Transducers.Map{ARTEMIS.var"#58#59"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{Base.UnitRange{Int64}, 1, Array{Base.UnitRange{Int64}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#58#59"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#58#59"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, ARTEMIS.var"#64#68"{ARTEMIS.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{ARTEMIS.var"#64#68"{ARTEMIS.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64}}, Array{Int64, 1}})
...
precompile(Tuple{ARTEMIS.var"#252#254", String})
...
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#47#52"}, Transducers.BottomRF{Transducers.Completing{typeof(Base.vcat)}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, ARTEMIS.var"#48#53"{Int64}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{ARTEMIS.var"#48#53"{Int64}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#48#53"{Int64}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{ARTEMIS.Path, 1}})
...
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#47#52"}, Transducers.BottomRF{Transducers.Completing{typeof(Base.vcat)}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
...
precompile(Tuple{Transducers.var"#167#168"{Transducers.Reduction{Transducers.Map{ARTEMIS.var"#48#53"{Int64}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#48#53"{Int64}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{ARTEMIS.Path, 1}, Array{ARTEMIS.Path, 1}})
precompile(Tuple{ThreadsX.Implementations.var"#95#96"{ThreadsX.Implementations.ParallelMergeSortAlg{Base.Sort.MergeSortAlg, Int64, Int64}, Base.Order.By{ARTEMIS.var"#49#54", Base.Order.ForwardOrdering}, Base.SubArray{ARTEMIS.Path, 1, Array{ARTEMIS.Path, 1}, Tuple{Base.UnitRange{Int64}}, true}, Base.SubArray{ARTEMIS.Path, 1, Array{ARTEMIS.Path, 1}, Tuple{Base.UnitRange{Int64}}, true}}})
precompile(Tuple{ThreadsX.Implementations.var"#93#94"{Base.Order.By{ARTEMIS.var"#49#54", Base.Order.ForwardOrdering}, Int64, Base.SubArray{ARTEMIS.Path, 1, Array{ARTEMIS.Path, 1}, Tuple{Base.UnitRange{Int64}}, true}, Base.SubArray{ARTEMIS.Path, 1, Array{ARTEMIS.Path, 1}, Tuple{Base.UnitRange{Int64}}, true}, Base.SubArray{ARTEMIS.Path, 1, Array{ARTEMIS.Path, 1}, Tuple{Base.UnitRange{Int64}}, true}}})
...
precompile(Tuple{typeof(Base._mapreduce), ARTEMIS.var"#186#190"{Int64}, typeof(Base.vcat), Base.IndexLinear, Array{ARTEMIS.Path, 1}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, ARTEMIS.var"#61#63"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, ARTEMIS.DBInfo}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{ARTEMIS.var"#61#63"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, ARTEMIS.DBInfo}}, Array{Base.UnitRange{Int64}, 1}})
precompile(Tuple{Transducers.var"#167#168"{Transducers.Reduction{Transducers.Map{ARTEMIS.var"#61#63"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, ARTEMIS.DBInfo}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{Base.UnitRange{Int64}, 1, Array{Base.UnitRange{Int64}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#61#63"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, ARTEMIS.DBInfo}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#61#63"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, ARTEMIS.DBInfo}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#194#197"{Base.UnitRange{Int64}}, Array{Base.UnitRange{Int64}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{Base.UnitRange{Int64}, 1}, Base.Generator{Array{Base.UnitRange{Int64}, 1}, ARTEMIS.var"#194#197"{Base.UnitRange{Int64}}}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#61#63"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, ARTEMIS.DBInfo}, Array{Base.UnitRange{Int64}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{Base.UnitRange{Int64}, 1}, Base.Generator{Array{Base.UnitRange{Int64}, 1}, ARTEMIS.var"#61#63"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, ARTEMIS.DBInfo}}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#64#68"{ARTEMIS.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64}, Array{Int64, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{Int64, 1}, Base.Generator{Array{Int64, 1}, ARTEMIS.var"#64#68"{ARTEMIS.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64}}})
...
precompile(Tuple{Type{ARTEMIS.AmbigIdx}, StaticArrays.SArray{Tuple{21, 36}, BioSymbols.DNA, 2, 756}, Array{String, 1}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#200#202"{ARTEMIS.VcfDB}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, ARTEMIS.var"#200#202"{ARTEMIS.VcfDB}}})
precompile(Tuple{typeof(Base._similar_for), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Type{Base.BitArray{1}}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, ARTEMIS.var"#200#202"{ARTEMIS.VcfDB}}, Base.HasShape{1}, Tuple{Base.OneTo{Int64}}})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Base.BitArray{1}, 1}, Base.BitArray{1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, ARTEMIS.var"#200#202"{ARTEMIS.VcfDB}}, Int64})
...
precompile(Tuple{typeof(Base.getproperty), ARTEMIS.PAMinFMI, Symbol})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#235#243"{Int64}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, ARTEMIS.var"#235#243"{Int64}}})
...
precompile(Tuple{typeof(Base._mapreduce), ARTEMIS.var"#236#244"{ARTEMIS.FMIndexes.FMIndex{4, UInt32}}, typeof(Base.vcat), Base.IndexLinear, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
...
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, typeof(Base.:(-)), Tuple{Array{Int64, 1}, Int64}})
precompile(Tuple{typeof(Base.Broadcast.materialize!), Array{Int64, 1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(-)), Tuple{Array{Int64, 1}, Int64}}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#237#245"{Int64, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, Array{Int64, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{Int64, 1}, Base.Generator{Array{Int64, 1}, ARTEMIS.var"#237#245"{Int64, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#238#246"{Int64, Int64}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, ARTEMIS.var"#238#246"{Int64, Int64}}})
...
precompile(Tuple{typeof(Base._mapreduce), ARTEMIS.var"#239#247"{ARTEMIS.FMIndexes.FMIndex{4, UInt32}}, typeof(Base.vcat), Base.IndexLinear, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#240#248"{Int64, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, Array{Int64, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{Int64, 1}, Base.Generator{Array{Int64, 1}, ARTEMIS.var"#240#248"{Int64, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#241#249"{Int64, Int64}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, ARTEMIS.var"#241#249"{Int64, Int64}}})
...
precompile(Tuple{ThreadsX.Implementations.var"#95#96"{ThreadsX.Implementations.ParallelMergeSortAlg{Base.Sort.MergeSortAlg, Int64, Int64}, Base.Order.By{ARTEMIS.var"#50#55", Base.Order.ForwardOrdering}, Base.SubArray{ARTEMIS.Path, 1, Array{ARTEMIS.Path, 1}, Tuple{Base.UnitRange{Int64}}, true}, Base.SubArray{ARTEMIS.Path, 1, Array{ARTEMIS.Path, 1}, Tuple{Base.UnitRange{Int64}}, true}}})
precompile(Tuple{ThreadsX.Implementations.var"#93#94"{Base.Order.By{ARTEMIS.var"#50#55", Base.Order.ForwardOrdering}, Int64, Base.SubArray{ARTEMIS.Path, 1, Array{ARTEMIS.Path, 1}, Tuple{Base.UnitRange{Int64}}, true}, Base.SubArray{ARTEMIS.Path, 1, Array{ARTEMIS.Path, 1}, Tuple{Base.UnitRange{Int64}}, true}, Base.SubArray{ARTEMIS.Path, 1, Array{ARTEMIS.Path, 1}, Tuple{Base.UnitRange{Int64}}, true}}})
precompile(Tuple{ThreadsX.Implementations.var"##_map#72", Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(ThreadsX.Implementations._map), Function, Base.Iterators.Zip{Tuple{Array{ARTEMIS.Path, 1}, Array{Int64, 1}}}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{ARTEMIS.var"#51#56"}, Base.Iterators.Zip{Tuple{Array{ARTEMIS.Path, 1}, Array{Int64, 1}}}})
precompile(Tuple{Transducers.var"#167#168"{Transducers.Reduction{Transducers.Map{ARTEMIS.var"#51#56"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.Iterators.Zip{Tuple{Base.SubArray{ARTEMIS.Path, 1, Array{ARTEMIS.Path, 1}, Tuple{Base.UnitRange{Int64}}, true}, Base.SubArray{Int64, 1, Array{Int64, 1}, Tuple{Base.UnitRange{Int64}}, true}}}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#51#56"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{ARTEMIS.Path, 1}, Array{ARTEMIS.Path, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#51#56"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{ARTEMIS.Path, 1}})
...
precompile(Tuple{typeof(Base._similar_for), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Type{Array{ARTEMIS.Path, 1}}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, ARTEMIS.var"#229#231"{Int64, ARTEMIS.MotifPathTemplates}}, Base.HasShape{1}, Tuple{Base.OneTo{Int64}}})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Array{ARTEMIS.Path, 1}, 1}, Array{ARTEMIS.Path, 1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, ARTEMIS.var"#229#231"{Int64, ARTEMIS.MotifPathTemplates}}, Int64})
precompile(Tuple{typeof(Base.Iterators.enumerate), Array{Array{ARTEMIS.Path, 1}, 1}})
precompile(Tuple{typeof(Base.iterate), Base.Iterators.Enumerate{Array{Array{ARTEMIS.Path, 1}, 1}}, Tuple{Int64}})
precompile(Tuple{typeof(Base.iterate), Array{ARTEMIS.Path, 1}})
precompile(Tuple{typeof(Base.getproperty), ARTEMIS.Path, Symbol})
precompile(Tuple{typeof(Base.count), BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, ARTEMIS.FMIndexes.FMIndex{4, UInt32}})
precompile(Tuple{typeof(Base.setindex!), Array{Int64, 2}, Int64, Int64, Int64})
precompile(Tuple{typeof(Base.iterate), Array{ARTEMIS.Path, 1}, Int64})
precompile(Tuple{typeof(Base.iterate), Base.Iterators.Enumerate{Array{Array{ARTEMIS.Path, 1}, 1}}, Tuple{Int64, Int64}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#126#128"{String, Int64, FASTX.FASTA.Reader{TranscodingStreams.TranscodingStream{TranscodingStreams.Noop, Base.IOStream}}, ARTEMIS.DBInfo}, Array{String, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{String, 1}, Base.Generator{Array{String, 1}, ARTEMIS.var"#126#128"{String, Int64, FASTX.FASTA.Reader{TranscodingStreams.TranscodingStream{TranscodingStreams.Noop, Base.IOStream}}, ARTEMIS.DBInfo}}})
precompile(Tuple{Type{Transducers.Map{F} where F}, ARTEMIS.var"#72#75"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{ARTEMIS.var"#72#75"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}}, Array{Base.UnitRange{Int64}, 1}})
precompile(Tuple{Transducers.var"#167#168"{Transducers.Reduction{Transducers.Map{ARTEMIS.var"#72#75"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{Base.UnitRange{Int64}, 1, Array{Base.UnitRange{Int64}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#72#75"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#72#75"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, ARTEMIS.var"#73#76"{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{ARTEMIS.Loc{UInt8, UInt32}, 1}}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{ARTEMIS.var"#73#76"{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{ARTEMIS.Loc{UInt8, UInt32}, 1}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.findall), Function, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{Transducers.var"#167#168"{Transducers.Reduction{Transducers.Map{ARTEMIS.var"#73#76"{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{ARTEMIS.Loc{UInt8, UInt32}, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, ARTEMIS.var"#74#77"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, Tuple{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}}})
precompile(Tuple{typeof(Base.Broadcast.materialize), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, ARTEMIS.var"#74#77"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, Tuple{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#73#76"{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{ARTEMIS.Loc{UInt8, UInt32}, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{ARTEMIS.PrefixDB, 1}, Array{ARTEMIS.PrefixDB, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#73#76"{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{ARTEMIS.Loc{UInt8, UInt32}, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{ARTEMIS.PrefixDB, 1}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#79#84", Array{ARTEMIS.PrefixDB, 1}})
precompile(Tuple{typeof(ThreadsX.collect), Base.Generator{Array{ARTEMIS.PrefixDB, 1}, ARTEMIS.var"#79#84"}})
precompile(Tuple{Transducers.var"#167#168"{Transducers.Reduction{Transducers.Map{ARTEMIS.var"#79#84"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{ARTEMIS.PrefixDB, 1, Array{ARTEMIS.PrefixDB, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#79#84"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#79#84"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(ThreadsX.Implementations.reshape_as), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{ARTEMIS.PrefixDB, 1}, ARTEMIS.var"#79#84"}})
precompile(Tuple{typeof(Base.unique), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{Type{Transducers.Map{F} where F}, ARTEMIS.var"#80#85"{String, String, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{ARTEMIS.PrefixDB, 1}, Array{ARTEMIS.PrefixDB, 1}}})
precompile(Tuple{typeof(Base.isbits), Any})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{ARTEMIS.var"#80#85"{String, String, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{ARTEMIS.PrefixDB, 1}, Array{ARTEMIS.PrefixDB, 1}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{Transducers.var"#167#168"{Transducers.Reduction{Transducers.Map{ARTEMIS.var"#80#85"{String, String, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{ARTEMIS.PrefixDB, 1}, Array{ARTEMIS.PrefixDB, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
...
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#80#85"{String, String, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{ARTEMIS.PrefixDB, 1}, Array{ARTEMIS.PrefixDB, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Nothing, 1}, Array{Nothing, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#80#85"{String, String, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{ARTEMIS.PrefixDB, 1}, Array{ARTEMIS.PrefixDB, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Nothing, 1}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, ARTEMIS.var"#127#129"{String, ARTEMIS.DBInfo}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{ARTEMIS.var"#127#129"{String, ARTEMIS.DBInfo}}, Base.Set{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}})
precompile(Tuple{Transducers.var"#167#168"{Transducers.Reduction{Transducers.Map{ARTEMIS.var"#127#129"{String, ARTEMIS.DBInfo}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{SplittablesBase.Implementations.DictView{Base.Dict{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Nothing}, typeof(Base.first)}, Int64}}})
...
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#127#129"{String, ARTEMIS.DBInfo}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Nothing, 1}, Array{Nothing, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#127#129"{String, ARTEMIS.DBInfo}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Nothing, 1}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, ARTEMIS.var"#135#140"{String, String, Int64, ARTEMIS.LinearDB}})
precompile(Tuple{Type{NamedTuple{(:init, :basesize), T} where T<:Tuple}, Tuple{InitialValues.InitialValueOf{typeof(Base.:(+))}, Int64}})
precompile(Tuple{Transducers.var"#foldxt##kw", NamedTuple{(:init, :basesize), Tuple{InitialValues.InitialValueOf{typeof(Base.:(+))}, Int64}}, typeof(Transducers.foldxt), typeof(Base.:(+)), Transducers.Map{ARTEMIS.var"#135#140"{String, String, Int64, ARTEMIS.LinearDB}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{Transducers.var"#167#168"{Transducers.Reduction{Transducers.Map{ARTEMIS.var"#135#140"{String, String, Int64, ARTEMIS.LinearDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, InitialValues.InitialValueOf{typeof(Base.:(+))}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#130#132"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64, Int64}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, ARTEMIS.var"#130#132"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64, Int64}}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#131#133", Array{ARTEMIS.PrefixAlignment{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{ARTEMIS.PrefixAlignment{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, 1}, Base.Generator{Array{ARTEMIS.PrefixAlignment{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, 1}, ARTEMIS.var"#131#133"}})
...
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#135#140"{String, String, Int64, ARTEMIS.LinearDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, Array{Int64, 2}, Array{Int64, 2}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#135#140"{String, String, Int64, ARTEMIS.LinearDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, Array{Int64, 2}})
precompile(Tuple{typeof(Transducers.unreduced), Array{Int64, 2}})
precompile(Tuple{Base.var"##open#355", Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), ARTEMIS.var"#136#141"{String}, String, Vararg{String}})
precompile(Tuple{Base.var"##open#355", Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), ARTEMIS.var"#138#143"{Base.IOStream}, String, Vararg{String}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, ARTEMIS.var"#44#45"{Int64}})
...
precompile(Tuple{Transducers.var"#foldxt##kw", NamedTuple{(:init, :basesize), Tuple{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Int64}}, typeof(Transducers.foldxt), typeof(Base.vcat), Transducers.Map{ARTEMIS.var"#44#45"{Int64}}, Array{Array{Int64, 1}, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#44#45"{Int64}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.vcat)}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
...
precompile(Tuple{Transducers.var"#167#168"{Transducers.Reduction{Transducers.Map{ARTEMIS.var"#44#45"{Int64}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.vcat)}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Transducers.CancellableDACContext, Transducers.SizedReducible{Base.SubArray{Array{Int64, 1}, 1, Array{Array{Int64, 1}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
...
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#44#45"{Int64}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.vcat)}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
...
precompile(Tuple{typeof(Base.mapfoldl_impl), ARTEMIS.var"#88#91"{ARTEMIS.DictDB}, typeof(Base.:(+)), Base._InitialValue, Base.Set{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#90#93", Base.UnitRange{Int64}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.UnitRange{Int64}, ARTEMIS.var"#90#93"}})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, typeof(Base.convert), Tuple{Base.RefValue{Type{UInt8}}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.min), Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.length), Tuple{Array{Base.UnitRange{UInt32}, 1}}}, Int64}}}})
precompile(Tuple{typeof(Base.Broadcast.materialize), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.convert), Tuple{Base.RefValue{Type{UInt8}}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.min), Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.length), Tuple{Array{Base.UnitRange{UInt32}, 1}}}, Int64}}}}})
...
precompile(Tuple{typeof(Base.push!), ARTEMIS.BloomFilter, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}})
precompile(Tuple{typeof(Base.iterate), Base.IdDict{UInt64, UInt8}, Int64})
precompile(Tuple{Type{ARTEMIS.BinDB{T} where T<:Unsigned}, Array{ARTEMIS.BloomFilter, 1}, Array{UInt8, 1}, ARTEMIS.MotifPathTemplates, ARTEMIS.DBInfo, Nothing})
precompile(Tuple{typeof(Serialization.serialize), Serialization.Serializer{Base.IOStream}, Array{ARTEMIS.BloomFilter, 1}})
...
precompile(Tuple{Type{Array{ARTEMIS.BloomFilter, 1}}, UndefInitializer, Tuple{Int64}})
precompile(Tuple{typeof(Base.length), Array{ARTEMIS.BloomFilter, 1}})
precompile(Tuple{typeof(Serialization.deserialize_fillarray!), Array{ARTEMIS.BloomFilter, 1}, Serialization.Serializer{Base.IOStream}})
precompile(Tuple{typeof(Base.setindex!), Array{ARTEMIS.BloomFilter, 1}, ARTEMIS.BloomFilter, Int64})
precompile(Tuple{typeof(Base.getproperty), ARTEMIS.BinDB{UInt8}, Symbol})
precompile(Tuple{typeof(Base._mapreduce), ARTEMIS.var"#170#176"{Int64}, typeof(Base.vcat), Base.IndexLinear, Array{ARTEMIS.Path, 1}})
precompile(Tuple{typeof(Base._mapreduce), ARTEMIS.var"#171#177"{Bool, ARTEMIS.BinDB{UInt8}}, typeof(Base.:(+)), Base.IndexLinear, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base._mapreduce), ARTEMIS.var"#172#178"{Bool, ARTEMIS.BinDB{UInt8}}, typeof(Base.:(+)), Base.IndexLinear, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
...
precompile(Tuple{Type{ARTEMIS.AmbigIdx}, StaticArrays.SArray{Tuple{21, 2}, BioSymbols.DNA, 2, 42}, Nothing})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#187#191"{ARTEMIS.HashDB{UInt8, UInt16}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, ARTEMIS.var"#187#191"{ARTEMIS.HashDB{UInt8, UInt16}}}})
...
precompile(Tuple{typeof(Base._similar_for), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Type{Base.BitArray{1}}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, ARTEMIS.var"#187#191"{ARTEMIS.HashDB{UInt8, UInt16}}}, Base.HasShape{1}, Tuple{Base.OneTo{Int64}}})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Base.BitArray{1}, 1}, Base.BitArray{1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, ARTEMIS.var"#187#191"{ARTEMIS.HashDB{UInt8, UInt16}}}, Int64})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#188#192"{ARTEMIS.HashDB{UInt8, UInt16}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, ARTEMIS.var"#188#192"{ARTEMIS.HashDB{UInt8, UInt16}}}})
precompile(Tuple{typeof(Base._similar_for), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Type{Base.BitArray{1}}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, ARTEMIS.var"#188#192"{ARTEMIS.HashDB{UInt8, UInt16}}}, Base.HasShape{1}, Tuple{Base.OneTo{Int64}}})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Base.BitArray{1}, 1}, Base.BitArray{1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, ARTEMIS.var"#188#192"{ARTEMIS.HashDB{UInt8, UInt16}}}, Int64})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#149#150"{String, Int64, FASTX.FASTA.Reader{TranscodingStreams.TranscodingStream{TranscodingStreams.Noop, Base.IOStream}}, ARTEMIS.DBInfo}, Array{String, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{String, 1}, Base.Generator{Array{String, 1}, ARTEMIS.var"#149#150"{String, Int64, FASTX.FASTA.Reader{TranscodingStreams.TranscodingStream{TranscodingStreams.Noop, Base.IOStream}}, ARTEMIS.DBInfo}}})
...
precompile(Tuple{typeof(Base._similar_for), Array{String, 1}, Type{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}}, Base.Generator{Array{String, 1}, ARTEMIS.var"#149#150"{String, Int64, FASTX.FASTA.Reader{TranscodingStreams.TranscodingStream{TranscodingStreams.Noop, Base.IOStream}}, ARTEMIS.DBInfo}}, Base.HasShape{1}, Tuple{Base.OneTo{Int64}}})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{String, 1}, ARTEMIS.var"#149#150"{String, Int64, FASTX.FASTA.Reader{TranscodingStreams.TranscodingStream{TranscodingStreams.Noop, Base.IOStream}}, ARTEMIS.DBInfo}}, Int64})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, ARTEMIS.var"#145#147"{Array{UInt32, 1}, Int64, Int64}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{ARTEMIS.var"#145#147"{Array{UInt32, 1}, Int64, Int64}}, Array{Int64, 1}})
precompile(Tuple{Transducers.var"#167#168"{Transducers.Reduction{Transducers.Map{ARTEMIS.var"#145#147"{Array{UInt32, 1}, Int64, Int64}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{Int64, 1, Array{Int64, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Base.getindex), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, UInt32})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#145#147"{Array{UInt32, 1}, Int64, Int64}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Int64, 1}, Array{Int64, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#145#147"{Array{UInt32, 1}, Int64, Int64}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Int64, 1}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#145#147"{Array{UInt32, 1}, Int64, Int64}, Array{Int64, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{Int64, 1}, Base.Generator{Array{Int64, 1}, ARTEMIS.var"#145#147"{Array{UInt32, 1}, Int64, Int64}}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, ARTEMIS.var"#146#148"{Array{UInt8, 1}, Array{UInt32, 1}, Array{UInt32, 1}}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{ARTEMIS.var"#146#148"{Array{UInt8, 1}, Array{UInt32, 1}, Array{UInt32, 1}}}, Base.UnitRange{Int64}})
precompile(Tuple{Transducers.var"#167#168"{Transducers.Reduction{Transducers.Map{ARTEMIS.var"#146#148"{Array{UInt8, 1}, Array{UInt32, 1}, Array{UInt32, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.UnitRange{Int64}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#146#148"{Array{UInt8, 1}, Array{UInt32, 1}, Array{UInt32, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{ARTEMIS.Node, 1}, Array{ARTEMIS.Node, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#146#148"{Array{UInt8, 1}, Array{UInt32, 1}, Array{UInt32, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{ARTEMIS.Node, 1}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, ARTEMIS.var"#154#159"{String, String, Int64, ARTEMIS.TreeDB}})
precompile(Tuple{Transducers.var"#foldxt##kw", NamedTuple{(:init, :basesize), Tuple{InitialValues.InitialValueOf{typeof(Base.:(+))}, Int64}}, typeof(Transducers.foldxt), typeof(Base.:(+)), Transducers.Map{ARTEMIS.var"#154#159"{String, String, Int64, ARTEMIS.TreeDB}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{Transducers.var"#167#168"{Transducers.Reduction{Transducers.Map{ARTEMIS.var"#154#159"{String, String, Int64, ARTEMIS.TreeDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, InitialValues.InitialValueOf{typeof(Base.:(+))}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#151#152"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64, Int64}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, ARTEMIS.var"#151#152"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64, Int64}}})
...
precompile(Tuple{typeof(Base.:(>)), Int64, UInt8})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#154#159"{String, String, Int64, ARTEMIS.TreeDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, Array{Int64, 2}, Array{Int64, 2}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#154#159"{String, String, Int64, ARTEMIS.TreeDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, Array{Int64, 2}})
precompile(Tuple{Base.var"##open#355", Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), ARTEMIS.var"#155#160"{String}, String, Vararg{String}})
precompile(Tuple{Base.var"##open#355", Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), ARTEMIS.var"#157#162"{Base.IOStream}, String, Vararg{String}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#97#102"{String, Int64, FASTX.FASTA.Reader{TranscodingStreams.TranscodingStream{TranscodingStreams.Noop, Base.IOStream}}, ARTEMIS.DBInfo}, Array{String, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{String, 1}, Base.Generator{Array{String, 1}, ARTEMIS.var"#97#102"{String, Int64, FASTX.FASTA.Reader{TranscodingStreams.TranscodingStream{TranscodingStreams.Noop, Base.IOStream}}, ARTEMIS.DBInfo}}})
precompile(Tuple{typeof(Base._similar_for), Array{String, 1}, Type{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}}, Base.Generator{Array{String, 1}, ARTEMIS.var"#97#102"{String, Int64, FASTX.FASTA.Reader{TranscodingStreams.TranscodingStream{TranscodingStreams.Noop, Base.IOStream}}, ARTEMIS.DBInfo}}, Base.HasShape{1}, Tuple{Base.OneTo{Int64}}})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{String, 1}, ARTEMIS.var"#97#102"{String, Int64, FASTX.FASTA.Reader{TranscodingStreams.TranscodingStream{TranscodingStreams.Noop, Base.IOStream}}, ARTEMIS.DBInfo}}, Int64})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, ARTEMIS.var"#98#103"})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{ARTEMIS.var"#98#103"}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
...
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#98#103"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Base.BitArray{1}, 1}, Array{Base.BitArray{1}, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#98#103"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Base.BitArray{1}, 1}})
...
precompile(Tuple{ThreadsX.Implementations.var"##map#74", Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(ThreadsX.map), Function, Array{ARTEMIS.Loc{T, K} where K<:Unsigned where T<:Unsigned, 1}})
...
precompile(Tuple{typeof(Transducers.next), Transducers.Reduction{Transducers.NoComplete, Transducers.Reduction{Transducers.Map{ARTEMIS.var"#99#104"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, ARTEMIS.Loc{UInt8, UInt32}})
precompile(Tuple{typeof(Transducers._foldl_linear_bulk), Transducers.Reduction{Transducers.NoComplete, Transducers.Reduction{Transducers.Map{ARTEMIS.var"#99#104"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}}, Array{UInt8, 1}, Base.SubArray{ARTEMIS.Loc{T, K} where K<:Unsigned where T<:Unsigned, 1, Array{ARTEMIS.Loc{T, K} where K<:Unsigned where T<:Unsigned, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64})
precompile(Tuple{typeof(Transducers.AutoObjectsReStacker.restack), Array{UInt8, 1}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#99#104"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{UInt8, 1}, Array{UInt8, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#99#104"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{UInt8, 1}})
...
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{ARTEMIS.var"#100#105"}, Array{ARTEMIS.Loc{T, K} where K<:Unsigned where T<:Unsigned, 1}})
precompile(Tuple{Transducers.var"#167#168"{Transducers.Reduction{Transducers.Map{ARTEMIS.var"#100#105"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.CancellableDACContext, Transducers.SizedReducible{Base.SubArray{ARTEMIS.Loc{T, K} where K<:Unsigned where T<:Unsigned, 1, Array{ARTEMIS.Loc{T, K} where K<:Unsigned where T<:Unsigned, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.next), Transducers.Reduction{Transducers.NoComplete, Transducers.Reduction{Transducers.Map{ARTEMIS.var"#100#105"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, ARTEMIS.Loc{UInt8, UInt32}})
precompile(Tuple{typeof(Transducers._foldl_linear_bulk), Transducers.Reduction{Transducers.NoComplete, Transducers.Reduction{Transducers.Map{ARTEMIS.var"#100#105"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}}, Array{UInt32, 1}, Base.SubArray{ARTEMIS.Loc{T, K} where K<:Unsigned where T<:Unsigned, 1, Array{ARTEMIS.Loc{T, K} where K<:Unsigned where T<:Unsigned, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64})
precompile(Tuple{typeof(Transducers.AutoObjectsReStacker.restack), Array{UInt32, 1}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#100#105"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{UInt32, 1}, Array{UInt32, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#100#105"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{UInt32, 1}})
...
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{ARTEMIS.var"#101#106"}, Array{ARTEMIS.Loc{T, K} where K<:Unsigned where T<:Unsigned, 1}})
precompile(Tuple{Transducers.var"#167#168"{Transducers.Reduction{Transducers.Map{ARTEMIS.var"#101#106"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{ARTEMIS.Loc{T, K} where K<:Unsigned where T<:Unsigned, 1, Array{ARTEMIS.Loc{T, K} where K<:Unsigned where T<:Unsigned, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#101#106"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Bool, 1}, Array{Bool, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#101#106"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Bool, 1}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, ARTEMIS.var"#114#120"{Int64, ARTEMIS.MotifDB}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{ARTEMIS.var"#114#120"{Int64, ARTEMIS.MotifDB}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{Transducers.var"#167#168"{Transducers.Reduction{Transducers.Map{ARTEMIS.var"#114#120"{Int64, ARTEMIS.MotifDB}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#114#120"{Int64, ARTEMIS.MotifDB}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, 1}, Array{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#114#120"{Int64, ARTEMIS.MotifDB}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, 1}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, ARTEMIS.var"#115#121"{String, Int64, String, Int64, Array{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, 1}, ARTEMIS.MotifDB}})
precompile(Tuple{Base.Cartesian.var"#@nloops", LineNumberNode, Module, Any, Any, Any, Vararg{Any}})
precompile(Tuple{Transducers.var"#foldxt##kw", NamedTuple{(:init, :basesize), Tuple{InitialValues.InitialValueOf{typeof(Base.:(+))}, Int64}}, typeof(Transducers.foldxt), typeof(Base.:(+)), Transducers.Map{ARTEMIS.var"#115#121"{String, Int64, String, Int64, Array{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, 1}, ARTEMIS.MotifDB}}, Base.Set{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}})
precompile(Tuple{Transducers.var"#167#168"{Transducers.Reduction{Transducers.Map{ARTEMIS.var"#115#121"{String, Int64, String, Int64, Array{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, 1}, ARTEMIS.MotifDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, InitialValues.InitialValueOf{typeof(Base.:(+))}, Transducers.NoopDACContext, Transducers.SizedReducible{SplittablesBase.Implementations.DictView{Base.Dict{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Nothing}, typeof(Base.first)}, Int64}}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#107#110"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64, Int64}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, ARTEMIS.var"#107#110"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64, Int64}}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#108#111", Array{ARTEMIS.PrefixAlignment{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{ARTEMIS.PrefixAlignment{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, 1}, Base.Generator{Array{ARTEMIS.PrefixAlignment{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, 1}, ARTEMIS.var"#108#111"}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, ARTEMIS.var"#109#112"{Int64}, Array{ARTEMIS.PrefixAlignment{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{ARTEMIS.PrefixAlignment{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, 1}, Base.Generator{Array{ARTEMIS.PrefixAlignment{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, 1}, ARTEMIS.var"#109#112"{Int64}}})
...
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#115#121"{String, Int64, String, Int64, Array{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, 1}, ARTEMIS.MotifDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, Array{Int64, 2}, Array{Int64, 2}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{ARTEMIS.var"#115#121"{String, Int64, String, Int64, Array{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, 1}, ARTEMIS.MotifDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, Array{Int64, 2}})
precompile(Tuple{Base.var"##open#355", Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), ARTEMIS.var"#116#122"{String}, String, Vararg{String}})
precompile(Tuple{Base.var"##open#355", Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), ARTEMIS.var"#118#124"{Base.IOStream}, String, Vararg{String}})
precompile(Tuple{typeof(Base.zeros), Int64})
precompile(Tuple{typeof(ARTEMIS.shrink_and_expand!), Base.BitArray{1}, Array{Int64, 1}})
...
precompile(Tuple{typeof(ARTEMIS.is_in_range), Array{UInt32, 1}, Base.BitArray{1}, Array{Int64, 1}, Bool, Bool, Int64, Int64, Int64, Int64})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, Main.var"#6#11"{Main.var"#remove_gap#9"}, Array{ARTEMIS.Aln, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{ARTEMIS.Aln, 1}, Base.Generator{Array{ARTEMIS.Aln, 1}, Main.var"#6#11"{Main.var"#remove_gap#9"}}})
precompile(Tuple{typeof(Base.map), Function, Array{ARTEMIS.Path, 1}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, Main.var"#7#12", Array{ARTEMIS.Path, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{ARTEMIS.Path, 1}, Base.Generator{Array{ARTEMIS.Path, 1}, Main.var"#7#12"}})
...
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.EachStringIndex{String}, ARTEMIS.var"#31#32"{String, String, typeof(ARTEMIS.notX)}}})
precompile(Tuple{ARTEMIS.var"#31#32"{String, String, typeof(ARTEMIS.notX)}, Int64})
...
precompile(Tuple{Type{ARTEMIS.AmbigIdx}, StaticArrays.SArray{Tuple{4, 4}, BioSymbols.DNA, 2, 16}, Array{String, 1}})
