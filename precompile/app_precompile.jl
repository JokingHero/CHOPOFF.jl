...
precompile(Tuple{typeof(Base.grow_to!), Base.Dict{Symbol, Any}, Tuple{Base.Pair{Symbol, String}, Base.Pair{Symbol, DataType}, Base.Pair{Symbol, CRISPRofftargetHunter.var"#259#260"}, Base.Pair{Symbol, Bool}}, Int64})
precompile(Tuple{Type{NamedTuple{(:help, :arg_type, :required, :range_tester), T} where T<:Tuple}, Tuple{String, DataType, Bool, CRISPRofftargetHunter.var"#259#260"}})
precompile(Tuple{typeof(Base.merge), NamedTuple{(), Tuple{}}, NamedTuple{(:help, :arg_type, :required, :range_tester), Tuple{String, DataType, Bool, CRISPRofftargetHunter.var"#259#260"}}})
precompile(Tuple{typeof(Base.pairs), NamedTuple{(:help, :arg_type, :required, :range_tester), Tuple{String, DataType, Bool, CRISPRofftargetHunter.var"#259#260"}}})
precompile(Tuple{typeof(Base.keys), Base.Iterators.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:help, :arg_type, :required, :range_tester), Tuple{String, DataType, Bool, CRISPRofftargetHunter.var"#259#260"}}}})
precompile(Tuple{Type{Base.Dict{Symbol, Any}}, Base.Iterators.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:help, :arg_type, :required, :range_tester), Tuple{String, DataType, Bool, CRISPRofftargetHunter.var"#259#260"}}}})
...
precompile(Tuple{CRISPRofftargetHunter.var"#259#260", String})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#243#251"{Int64}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, CRISPRofftargetHunter.var"#243#251"{Int64}}})
...
precompile(Tuple{typeof(Base._mapreduce), CRISPRofftargetHunter.var"#244#252"{CRISPRofftargetHunter.FMIndexes.FMIndex{4, UInt32}}, typeof(Base.vcat), Base.IndexLinear, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
...
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, typeof(Base.:(-)), Tuple{Array{Int64, 1}, Int64}})
precompile(Tuple{typeof(Base.Broadcast.materialize!), Array{Int64, 1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(-)), Tuple{Array{Int64, 1}, Int64}}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#245#253"{Int64, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, Array{Int64, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{Int64, 1}, Base.Generator{Array{Int64, 1}, CRISPRofftargetHunter.var"#245#253"{Int64, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#246#254"{Int64, Int64}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, CRISPRofftargetHunter.var"#246#254"{Int64, Int64}}})
...
precompile(Tuple{typeof(Base._mapreduce), CRISPRofftargetHunter.var"#247#255"{CRISPRofftargetHunter.FMIndexes.FMIndex{4, UInt32}}, typeof(Base.vcat), Base.IndexLinear, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#248#256"{Int64, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, Array{Int64, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{Int64, 1}, Base.Generator{Array{Int64, 1}, CRISPRofftargetHunter.var"#248#256"{Int64, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#249#257"{Int64, Int64}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, CRISPRofftargetHunter.var"#249#257"{Int64, Int64}}})
