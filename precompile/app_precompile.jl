...
precompile(Tuple{typeof(Base.pairs), NamedTuple{(:backend,), Tuple{Symbol}}})
...
precompile(Tuple{typeof(CHOPOFF.Sassy.search_sassy_impl), Array{Int64, 1}, Array{UInt8, 1}, Int64, Array{UInt8, 1}, Base.Val{4}, Base.Val{true}, Base.Val{:avx2}})
precompile(Tuple{typeof(CHOPOFF.Sassy.search_sassy_impl), Array{Int64, 1}, Array{UInt8, 1}, Int64, Array{UInt8, 1}, Base.Val{4}, Base.Val{false}, Base.Val{:avx2}})
precompile(Tuple{typeof(CHOPOFF.Sassy.search_sassy_impl), Array{Int64, 1}, Array{UInt8, 1}, Int64, Array{UInt8, 1}, Base.Val{8}, Base.Val{true}, Base.Val{:avx512}})
precompile(Tuple{typeof(CHOPOFF.Sassy.resolve_sassy_backend), Symbol})
precompile(Tuple{typeof(CHOPOFF.Sassy.encode_block_avx2!), Array{UInt64, 2}, Int64, Array{UInt8, 1}, Int64, Int64, Array{UInt8, 1}})
precompile(Tuple{typeof(CHOPOFF.Sassy.encode_block_avx512!), Array{UInt64, 2}, Int64, Array{UInt8, 1}, Int64, Int64, Array{UInt8, 1}})
...
precompile(Tuple{typeof(Core.kwcall), NamedTuple{(:distance, :backend), Tuple{Int64, Symbol}}, typeof(CHOPOFF.Sassy.search_sassy), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, String, CHOPOFF.Motif, String})
