...
precompile(Tuple{Type{ARTEMIS.HashDB{T, K} where K<:Union{UInt16, UInt32, UInt8} where T<:Unsigned}, ARTEMIS.DBInfo, ARTEMIS.MotifPathTemplates, Array{FastFilter.BinaryFuseFilter{UInt16}, 1}, Array{UInt8, 1}, Nothing})
...
precompile(Tuple{Type{ARTEMIS.DictDB}, Base.IdDict{UInt64, UInt32}, ARTEMIS.MotifPathTemplates, ARTEMIS.DBInfo, Nothing})
...
precompile(Tuple{typeof(Base.getproperty), ARTEMIS.MotifPathTemplates, Symbol})
...
precompile(Tuple{Type{ARTEMIS.HashDB{T, K} where K<:Union{UInt16, UInt32, UInt8} where T<:Unsigned}, ARTEMIS.DBInfo, ARTEMIS.MotifPathTemplates, Array{FastFilter.BinaryFuseFilter{UInt16}, 1}, Array{UInt8, 1}, ARTEMIS.AmbigIdx})
...
precompile(Tuple{typeof(ARTEMIS.build_motifTemplates), ARTEMIS.Motif})
precompile(Tuple{Type{NamedTuple{(:dist,), T} where T<:Tuple}, Tuple{Int64}})
precompile(Tuple{ARTEMIS.var"#templates_to_sequences##kw", NamedTuple{(:dist,), Tuple{Int64}}, typeof(ARTEMIS.templates_to_sequences), BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, ARTEMIS.MotifPathTemplates})
