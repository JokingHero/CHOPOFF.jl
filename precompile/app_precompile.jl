...
precompile(Tuple{typeof(Base.grow_to!), Base.Dict{Symbol, Any}, Tuple{Base.Pair{Symbol, String}, Base.Pair{Symbol, DataType}, Base.Pair{Symbol, CRISPRofftargetHunter.var"#162#163"}, Base.Pair{Symbol, Bool}}, Int64})
precompile(Tuple{Type{NamedTuple{(:help, :arg_type, :required, :range_tester), T} where T<:Tuple}, Tuple{String, DataType, Bool, CRISPRofftargetHunter.var"#162#163"}})
precompile(Tuple{typeof(Base.merge), NamedTuple{(), Tuple{}}, NamedTuple{(:help, :arg_type, :required, :range_tester), Tuple{String, DataType, Bool, CRISPRofftargetHunter.var"#162#163"}}})
precompile(Tuple{typeof(Base.pairs), NamedTuple{(:help, :arg_type, :required, :range_tester), Tuple{String, DataType, Bool, CRISPRofftargetHunter.var"#162#163"}}})
precompile(Tuple{typeof(Base.keys), Base.Iterators.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:help, :arg_type, :required, :range_tester), Tuple{String, DataType, Bool, CRISPRofftargetHunter.var"#162#163"}}}})
precompile(Tuple{Type{Base.Dict{Symbol, Any}}, Base.Iterators.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:help, :arg_type, :required, :range_tester), Tuple{String, DataType, Bool, CRISPRofftargetHunter.var"#162#163"}}}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#31#32"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{CRISPRofftargetHunter.var"#31#32"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}}, Array{Base.UnitRange{Int64}, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#31#32"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{Base.UnitRange{Int64}, 1, Array{Base.UnitRange{Int64}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#31#32"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#31#32"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#38#42"{CRISPRofftargetHunter.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{CRISPRofftargetHunter.var"#38#42"{CRISPRofftargetHunter.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}}, Array{Int64, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#38#42"{CRISPRofftargetHunter.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{Int64, 1, Array{Int64, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#38#42"{CRISPRofftargetHunter.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#38#42"{CRISPRofftargetHunter.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#37#41"{CRISPRofftargetHunter.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{CRISPRofftargetHunter.var"#37#41"{CRISPRofftargetHunter.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64}}, Array{Int64, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#37#41"{CRISPRofftargetHunter.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{Int64, 1, Array{Int64, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#37#41"{CRISPRofftargetHunter.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#37#41"{CRISPRofftargetHunter.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
...
precompile(Tuple{CRISPRofftargetHunter.var"#162#163", String})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#33#35"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, CRISPRofftargetHunter.DBInfo}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{CRISPRofftargetHunter.var"#33#35"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, CRISPRofftargetHunter.DBInfo}}, Array{Base.UnitRange{Int64}, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#33#35"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, CRISPRofftargetHunter.DBInfo}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{Base.UnitRange{Int64}, 1, Array{Base.UnitRange{Int64}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#33#35"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, CRISPRofftargetHunter.DBInfo}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#33#35"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, CRISPRofftargetHunter.DBInfo}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#34#36"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, CRISPRofftargetHunter.DBInfo}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{CRISPRofftargetHunter.var"#34#36"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, CRISPRofftargetHunter.DBInfo}}, Array{Base.UnitRange{Int64}, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#34#36"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, CRISPRofftargetHunter.DBInfo}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{Base.UnitRange{Int64}, 1, Array{Base.UnitRange{Int64}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#34#36"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, CRISPRofftargetHunter.DBInfo}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#34#36"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, CRISPRofftargetHunter.DBInfo}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#152#155"{Base.UnitRange{Int64}}, Array{Base.UnitRange{Int64}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{Base.UnitRange{Int64}, 1}, Base.Generator{Array{Base.UnitRange{Int64}, 1}, CRISPRofftargetHunter.var"#152#155"{Base.UnitRange{Int64}}}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#34#36"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, CRISPRofftargetHunter.DBInfo}, Array{Base.UnitRange{Int64}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{Base.UnitRange{Int64}, 1}, Base.Generator{Array{Base.UnitRange{Int64}, 1}, CRISPRofftargetHunter.var"#34#36"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, CRISPRofftargetHunter.DBInfo}}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#37#41"{CRISPRofftargetHunter.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64}, Array{Int64, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{Int64, 1}, Base.Generator{Array{Int64, 1}, CRISPRofftargetHunter.var"#37#41"{CRISPRofftargetHunter.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64}}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#158#160"{CRISPRofftargetHunter.VcfDB}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, CRISPRofftargetHunter.var"#158#160"{CRISPRofftargetHunter.VcfDB}}})
precompile(Tuple{typeof(Base._similar_for), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Type{Base.BitArray{1}}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, CRISPRofftargetHunter.var"#158#160"{CRISPRofftargetHunter.VcfDB}}, Base.HasShape{1}})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Base.BitArray{1}, 1}, Base.BitArray{1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, CRISPRofftargetHunter.var"#158#160"{CRISPRofftargetHunter.VcfDB}}, Int64})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#72#74"{String, Int64, FASTX.FASTA.Reader{TranscodingStreams.TranscodingStream{TranscodingStreams.Noop, Base.IOStream}}, CRISPRofftargetHunter.DBInfo}, Array{String, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{String, 1}, Base.Generator{Array{String, 1}, CRISPRofftargetHunter.var"#72#74"{String, Int64, FASTX.FASTA.Reader{TranscodingStreams.TranscodingStream{TranscodingStreams.Noop, Base.IOStream}}, CRISPRofftargetHunter.DBInfo}}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#45#48"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{CRISPRofftargetHunter.var"#45#48"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}}, Array{Base.UnitRange{Int64}, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#45#48"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{Base.UnitRange{Int64}, 1, Array{Base.UnitRange{Int64}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#45#48"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#45#48"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#46#49"{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{CRISPRofftargetHunter.Loc{UInt8, UInt32}, 1}}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{CRISPRofftargetHunter.var"#46#49"{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{CRISPRofftargetHunter.Loc{UInt8, UInt32}, 1}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#46#49"{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{CRISPRofftargetHunter.Loc{UInt8, UInt32}, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#46#49"{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{CRISPRofftargetHunter.Loc{UInt8, UInt32}, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{CRISPRofftargetHunter.PrefixDB, 1}, Array{CRISPRofftargetHunter.PrefixDB, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#46#49"{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{CRISPRofftargetHunter.Loc{UInt8, UInt32}, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{CRISPRofftargetHunter.PrefixDB, 1}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#51#56", Array{CRISPRofftargetHunter.PrefixDB, 1}})
precompile(Tuple{typeof(ThreadsX.collect), Base.Generator{Array{CRISPRofftargetHunter.PrefixDB, 1}, CRISPRofftargetHunter.var"#51#56"}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#51#56"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{CRISPRofftargetHunter.PrefixDB, 1, Array{CRISPRofftargetHunter.PrefixDB, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
...
precompile(Tuple{typeof(ThreadsX.Implementations.reshape_as), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{CRISPRofftargetHunter.PrefixDB, 1}, CRISPRofftargetHunter.var"#51#56"}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#52#57", Array{CRISPRofftargetHunter.PrefixDB, 1}})
precompile(Tuple{typeof(ThreadsX.collect), Base.Generator{Array{CRISPRofftargetHunter.PrefixDB, 1}, CRISPRofftargetHunter.var"#52#57"}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#52#57"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{CRISPRofftargetHunter.PrefixDB, 1, Array{CRISPRofftargetHunter.PrefixDB, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#52#57"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#52#57"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(ThreadsX.Implementations.reshape_as), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{CRISPRofftargetHunter.PrefixDB, 1}, CRISPRofftargetHunter.var"#52#57"}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#53#58"{String, String, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{CRISPRofftargetHunter.PrefixDB, 1}, Array{CRISPRofftargetHunter.PrefixDB, 1}}})
precompile(Tuple{typeof(Base.isbits), Any})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{CRISPRofftargetHunter.var"#53#58"{String, String, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{CRISPRofftargetHunter.PrefixDB, 1}, Array{CRISPRofftargetHunter.PrefixDB, 1}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#53#58"{String, String, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{CRISPRofftargetHunter.PrefixDB, 1}, Array{CRISPRofftargetHunter.PrefixDB, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
...
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#53#58"{String, String, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{CRISPRofftargetHunter.PrefixDB, 1}, Array{CRISPRofftargetHunter.PrefixDB, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Nothing, 1}, Array{Nothing, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#53#58"{String, String, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{CRISPRofftargetHunter.PrefixDB, 1}, Array{CRISPRofftargetHunter.PrefixDB, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Nothing, 1}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#73#75"{String, CRISPRofftargetHunter.DBInfo}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{CRISPRofftargetHunter.var"#73#75"{String, CRISPRofftargetHunter.DBInfo}}, Base.Set{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#73#75"{String, CRISPRofftargetHunter.DBInfo}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{SplittablesBase.Implementations.DictView{Base.Dict{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Nothing}, typeof(Base.first)}, Int64}}})
...
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#73#75"{String, CRISPRofftargetHunter.DBInfo}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Nothing, 1}, Array{Nothing, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#73#75"{String, CRISPRofftargetHunter.DBInfo}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Nothing, 1}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#81#86"{String, String, Int64, CRISPRofftargetHunter.LinearDB}})
precompile(Tuple{Type{NamedTuple{(:init, :basesize), T} where T<:Tuple}, Tuple{InitialValues.InitialValueOf{typeof(Base.:(+))}, Int64}})
precompile(Tuple{Transducers.var"#foldxt##kw", NamedTuple{(:init, :basesize), Tuple{InitialValues.InitialValueOf{typeof(Base.:(+))}, Int64}}, typeof(Transducers.foldxt), typeof(Base.:(+)), Transducers.Map{CRISPRofftargetHunter.var"#81#86"{String, String, Int64, CRISPRofftargetHunter.LinearDB}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#81#86"{String, String, Int64, CRISPRofftargetHunter.LinearDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, InitialValues.InitialValueOf{typeof(Base.:(+))}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#76#78"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64, Int64}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, CRISPRofftargetHunter.var"#76#78"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64, Int64}}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#77#79", Array{CRISPRofftargetHunter.PrefixAlignment{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{CRISPRofftargetHunter.PrefixAlignment{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, 1}, Base.Generator{Array{CRISPRofftargetHunter.PrefixAlignment{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, 1}, CRISPRofftargetHunter.var"#77#79"}})
...
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#81#86"{String, String, Int64, CRISPRofftargetHunter.LinearDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, Array{Int64, 2}, Array{Int64, 2}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#81#86"{String, String, Int64, CRISPRofftargetHunter.LinearDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, Array{Int64, 2}})
precompile(Tuple{typeof(Transducers.unreduced), Array{Int64, 2}})
precompile(Tuple{Base.var"##open#317", Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), CRISPRofftargetHunter.var"#82#87"{String}, String, Vararg{String, N} where N})
precompile(Tuple{Base.var"##open#317", Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), CRISPRofftargetHunter.var"#84#89"{Base.IOStream}, String, Vararg{String, N} where N})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#62#67"{CRISPRofftargetHunter.DictDB}, Array{String, 1}})
precompile(Tuple{typeof(ThreadsX.sum), Base.Generator{Array{String, 1}, CRISPRofftargetHunter.var"#62#67"{CRISPRofftargetHunter.DictDB}}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#62#67"{CRISPRofftargetHunter.DictDB}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}}, InitialValues.InitialValueOf{typeof(Base.add_sum)}, Transducers.CancellableDACContext, Transducers.SizedReducible{Base.SubArray{String, 1, Array{String, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Base.add_sum), InitialValues.InitialValueOf{typeof(Base.add_sum)}, Int64})
precompile(Tuple{typeof(Transducers._foldl_linear_bulk), Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.NoComplete, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#62#67"{CRISPRofftargetHunter.DictDB}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}}}, Int64, Base.SubArray{String, 1, Array{String, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64})
precompile(Tuple{typeof(Transducers.next), Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.NoComplete, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#62#67"{CRISPRofftargetHunter.DictDB}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}}}, Int64, String})
precompile(Tuple{typeof(Base.add_sum), Int64, Int64})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.NoComplete, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#62#67"{CRISPRofftargetHunter.DictDB}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}}}, Int64})
precompile(Tuple{typeof(Transducers.AutoObjectsReStacker.restack), Int64})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#62#67"{CRISPRofftargetHunter.DictDB}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}}, Int64, Int64})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#62#67"{CRISPRofftargetHunter.DictDB}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}, Int64})
precompile(Tuple{typeof(Transducers.unreduced), Int64})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#63#68"{CRISPRofftargetHunter.DictDB}, Array{String, 1}})
precompile(Tuple{typeof(ThreadsX.sum), Base.Generator{Array{String, 1}, CRISPRofftargetHunter.var"#63#68"{CRISPRofftargetHunter.DictDB}}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#63#68"{CRISPRofftargetHunter.DictDB}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}}, InitialValues.InitialValueOf{typeof(Base.add_sum)}, Transducers.CancellableDACContext, Transducers.SizedReducible{Base.SubArray{String, 1, Array{String, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers._foldl_linear_bulk), Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.NoComplete, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#63#68"{CRISPRofftargetHunter.DictDB}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}}}, Int64, Base.SubArray{String, 1, Array{String, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.NoComplete, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#63#68"{CRISPRofftargetHunter.DictDB}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}}}, Int64})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#63#68"{CRISPRofftargetHunter.DictDB}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}}, Int64, Int64})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#63#68"{CRISPRofftargetHunter.DictDB}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}, Int64})
...
precompile(Tuple{typeof(Transducers.next), Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.NoComplete, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#63#68"{CRISPRofftargetHunter.DictDB}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}}}, Int64, String})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#134#137"{CRISPRofftargetHunter.BinDB{UInt8}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(ThreadsX.sum), Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, CRISPRofftargetHunter.var"#134#137"{CRISPRofftargetHunter.BinDB{UInt8}}}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#134#137"{CRISPRofftargetHunter.BinDB{UInt8}}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}}, InitialValues.InitialValueOf{typeof(Base.add_sum)}, Transducers.CancellableDACContext, Transducers.SizedReducible{Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#134#137"{CRISPRofftargetHunter.BinDB{UInt8}}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}}, Int64, Int64})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#134#137"{CRISPRofftargetHunter.BinDB{UInt8}}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}, Int64})
...
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#134#137"{CRISPRofftargetHunter.BinDB{UInt8}}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}, UInt64})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#142#144"{CRISPRofftargetHunter.HashDB{UInt8}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, CRISPRofftargetHunter.var"#142#144"{CRISPRofftargetHunter.HashDB{UInt8}}}})
precompile(Tuple{typeof(Base._similar_for), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Type{Base.BitArray{1}}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, CRISPRofftargetHunter.var"#142#144"{CRISPRofftargetHunter.HashDB{UInt8}}}, Base.HasShape{1}})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Base.BitArray{1}, 1}, Base.BitArray{1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, CRISPRofftargetHunter.var"#142#144"{CRISPRofftargetHunter.HashDB{UInt8}}}, Int64})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#146#149"{CRISPRofftargetHunter.NoHashDB}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, CRISPRofftargetHunter.var"#146#149"{CRISPRofftargetHunter.NoHashDB}}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#147#150"{CRISPRofftargetHunter.NoHashDB}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, CRISPRofftargetHunter.var"#147#150"{CRISPRofftargetHunter.NoHashDB}}})
precompile(Tuple{typeof(Base._similar_for), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Type{Base.BitArray{1}}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, CRISPRofftargetHunter.var"#147#150"{CRISPRofftargetHunter.NoHashDB}}, Base.HasShape{1}})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Base.BitArray{1}, 1}, Base.BitArray{1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, CRISPRofftargetHunter.var"#147#150"{CRISPRofftargetHunter.NoHashDB}}, Int64})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#112#113"{String, Int64, FASTX.FASTA.Reader{TranscodingStreams.TranscodingStream{TranscodingStreams.Noop, Base.IOStream}}, CRISPRofftargetHunter.DBInfo}, Array{String, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{String, 1}, Base.Generator{Array{String, 1}, CRISPRofftargetHunter.var"#112#113"{String, Int64, FASTX.FASTA.Reader{TranscodingStreams.TranscodingStream{TranscodingStreams.Noop, Base.IOStream}}, CRISPRofftargetHunter.DBInfo}}})
precompile(Tuple{typeof(Base._similar_for), Array{String, 1}, Type{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}}, Base.Generator{Array{String, 1}, CRISPRofftargetHunter.var"#112#113"{String, Int64, FASTX.FASTA.Reader{TranscodingStreams.TranscodingStream{TranscodingStreams.Noop, Base.IOStream}}, CRISPRofftargetHunter.DBInfo}}, Base.HasShape{1}})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{String, 1}, CRISPRofftargetHunter.var"#112#113"{String, Int64, FASTX.FASTA.Reader{TranscodingStreams.TranscodingStream{TranscodingStreams.Noop, Base.IOStream}}, CRISPRofftargetHunter.DBInfo}}, Int64})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#108#110"{Array{UInt32, 1}, Int64, Int64}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{CRISPRofftargetHunter.var"#108#110"{Array{UInt32, 1}, Int64, Int64}}, Array{Int64, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#108#110"{Array{UInt32, 1}, Int64, Int64}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.CancellableDACContext, Transducers.SizedReducible{Base.SubArray{Int64, 1, Array{Int64, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
...
precompile(Tuple{typeof(Transducers._foldl_linear_bulk), Transducers.Reduction{Transducers.NoComplete, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#108#110"{Array{UInt32, 1}, Int64, Int64}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}}, Array{Int64, 1}, Base.SubArray{Int64, 1, Array{Int64, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64})
precompile(Tuple{typeof(Transducers.AutoObjectsReStacker.restack), Array{Int64, 1}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#108#110"{Array{UInt32, 1}, Int64, Int64}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Int64, 1}, Array{Int64, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#108#110"{Array{UInt32, 1}, Int64, Int64}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Int64, 1}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#108#110"{Array{UInt32, 1}, Int64, Int64}, Array{Int64, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{Int64, 1}, Base.Generator{Array{Int64, 1}, CRISPRofftargetHunter.var"#108#110"{Array{UInt32, 1}, Int64, Int64}}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#109#111"{Array{UInt8, 1}, Array{UInt32, 1}, Array{UInt32, 1}}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{CRISPRofftargetHunter.var"#109#111"{Array{UInt8, 1}, Array{UInt32, 1}, Array{UInt32, 1}}}, Base.UnitRange{Int64}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#109#111"{Array{UInt8, 1}, Array{UInt32, 1}, Array{UInt32, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.UnitRange{Int64}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#109#111"{Array{UInt8, 1}, Array{UInt32, 1}, Array{UInt32, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{CRISPRofftargetHunter.Node, 1}, Array{CRISPRofftargetHunter.Node, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#109#111"{Array{UInt8, 1}, Array{UInt32, 1}, Array{UInt32, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{CRISPRofftargetHunter.Node, 1}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#117#122"{String, String, Int64, CRISPRofftargetHunter.TreeDB}})
precompile(Tuple{Transducers.var"#foldxt##kw", NamedTuple{(:init, :basesize), Tuple{InitialValues.InitialValueOf{typeof(Base.:(+))}, Int64}}, typeof(Transducers.foldxt), typeof(Base.:(+)), Transducers.Map{CRISPRofftargetHunter.var"#117#122"{String, String, Int64, CRISPRofftargetHunter.TreeDB}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#117#122"{String, String, Int64, CRISPRofftargetHunter.TreeDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, InitialValues.InitialValueOf{typeof(Base.:(+))}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#114#115"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64, Int64}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, CRISPRofftargetHunter.var"#114#115"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64, Int64}}})
...
precompile(Tuple{typeof(Base.:(>)), Int64, UInt8})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#117#122"{String, String, Int64, CRISPRofftargetHunter.TreeDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, Array{Int64, 2}, Array{Int64, 2}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#117#122"{String, String, Int64, CRISPRofftargetHunter.TreeDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, Array{Int64, 2}})
precompile(Tuple{Base.var"##open#317", Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), CRISPRofftargetHunter.var"#118#123"{String}, String, Vararg{String, N} where N})
precompile(Tuple{Base.var"##open#317", Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), CRISPRofftargetHunter.var"#120#125"{Base.IOStream}, String, Vararg{String, N} where N})
...
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.Filter{ThreadsX.Implementations.var"#43#44"{CRISPRofftargetHunter.var"#92#94", Array{Base.UnitRange{UInt32}, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{Int64, 1, Base.LinearIndices{1, Tuple{Base.OneTo{Int64}}}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
...
precompile(Tuple{Base.var"##open#317", Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), CRISPRofftargetHunter.var"#100#104"{String}, String, Vararg{String, N} where N})
precompile(Tuple{Base.var"##open#317", Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), CRISPRofftargetHunter.var"#102#106"{Base.IOStream}, String, Vararg{String, N} where N})
