...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CHOPOFF.Sassy.var"#3#11", Base.UnitRange{Int64}})
precompile(Tuple{typeof(Base.getproperty), Base.Generator{Base.UnitRange{Int64}, CHOPOFF.Sassy.var"#3#11"}, Symbol})
precompile(Tuple{typeof(Base._similar_shape), Base.Generator{Base.UnitRange{Int64}, CHOPOFF.Sassy.var"#3#11"}, Base.HasShape{1}})
...
precompile(Tuple{typeof(ThreadsX.foreach), CHOPOFF.Sassy.var"#30#34"{Int64, Bool, Symbol, CHOPOFF.Motif, Array{Array{CHOPOFF.Offtarget{T, K} where K<:Unsigned where T<:Unsigned, 1}, 1}, Array{Int64, 2}, Base.BitArray{1}, Array{Int64, 1}, Bool, CHOPOFF.DBInfo, CHOPOFF.Sassy.var"#28#32"{Bool}, Int64, String, Int64}, Base.Iterators.Enumerate{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}}})
precompile(Tuple{typeof(CHOPOFF.Sassy.search_sassy_impl), Array{Int64, 1}, Base.CodeUnits{UInt8, String}, Int64, Array{UInt8, 1}, Base.Val{4}, Base.Val{true}})
precompile(Tuple{Type{CHOPOFF.Loc{T, K} where K<:Unsigned where T<:Unsigned}, UInt8, UInt32, Bool})
precompile(Tuple{Transducers.var"#254#255"{Transducers.Reduction{Transducers.Map{CHOPOFF.Sassy.var"#30#34"{Int64, Bool, Symbol, CHOPOFF.Motif, Array{Array{CHOPOFF.Offtarget{T, K} where K<:Unsigned where T<:Unsigned, 1}, 1}, Array{Int64, 2}, Base.BitArray{1}, Array{Int64, 1}, Bool, CHOPOFF.DBInfo, CHOPOFF.Sassy.var"#28#32"{Bool}, Int64, String, Int64}}, Transducers.BottomRF{Transducers.Completing{typeof(ThreadsX.Implementations.return_nothing)}}}, Nothing, Transducers.CancellableDACContext, Transducers.SizedReducible{Base.Iterators.Zip{Tuple{Base.UnitRange{Int64}, Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}}}, Int64}}})
...
precompile(Tuple{typeof(CHOPOFF.Sassy.search_sassy_impl), Array{Int64, 1}, Base.CodeUnits{UInt8, String}, Int64, Array{UInt8, 1}, Base.Val{4}, Base.Val{false}})
