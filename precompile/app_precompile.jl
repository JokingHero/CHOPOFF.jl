...
precompile(Tuple{typeof(Base.grow_to!), Base.Dict{Symbol, Any}, Tuple{Base.Pair{Symbol, String}, Base.Pair{Symbol, DataType}, Base.Pair{Symbol, CRISPRofftargetHunter.var"#166#167"}, Base.Pair{Symbol, Bool}}, Int64})
precompile(Tuple{Type{NamedTuple{(:help, :arg_type, :required, :range_tester), T} where T<:Tuple}, Tuple{String, DataType, Bool, CRISPRofftargetHunter.var"#166#167"}})
precompile(Tuple{typeof(Base.merge), NamedTuple{(), Tuple{}}, NamedTuple{(:help, :arg_type, :required, :range_tester), Tuple{String, DataType, Bool, CRISPRofftargetHunter.var"#166#167"}}})
precompile(Tuple{typeof(Base.pairs), NamedTuple{(:help, :arg_type, :required, :range_tester), Tuple{String, DataType, Bool, CRISPRofftargetHunter.var"#166#167"}}})
precompile(Tuple{typeof(Base.keys), Base.Iterators.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:help, :arg_type, :required, :range_tester), Tuple{String, DataType, Bool, CRISPRofftargetHunter.var"#166#167"}}}})
precompile(Tuple{Type{Base.Dict{Symbol, Any}}, Base.Iterators.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:help, :arg_type, :required, :range_tester), Tuple{String, DataType, Bool, CRISPRofftargetHunter.var"#166#167"}}}})
...
precompile(Tuple{Type{CRISPRofftargetHunter.DBInfo}, String, Dates.DateTime, String, UInt32, String, Array{String, 1}, DataType, DataType, Bool, CRISPRofftargetHunter.Motif})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#31#33"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{CRISPRofftargetHunter.var"#31#33"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}}, Array{Base.UnitRange{Int64}, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#31#33"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{Base.UnitRange{Int64}, 1, Array{Base.UnitRange{Int64}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#31#33"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#31#33"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#40#44"{CRISPRofftargetHunter.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{CRISPRofftargetHunter.var"#40#44"{CRISPRofftargetHunter.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}}, Array{Int64, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#40#44"{CRISPRofftargetHunter.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{Int64, 1, Array{Int64, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#40#44"{CRISPRofftargetHunter.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#40#44"{CRISPRofftargetHunter.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
...
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{CRISPRofftargetHunter.var"#32#34"}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#32#34"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#32#34"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Bool, 1}, Array{Bool, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#32#34"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Bool, 1}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#39#43"{CRISPRofftargetHunter.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{CRISPRofftargetHunter.var"#39#43"{CRISPRofftargetHunter.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64}}, Array{Int64, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#39#43"{CRISPRofftargetHunter.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{Int64, 1, Array{Int64, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#39#43"{CRISPRofftargetHunter.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#39#43"{CRISPRofftargetHunter.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
...
precompile(Tuple{CRISPRofftargetHunter.var"#166#167", String})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#35#37"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, CRISPRofftargetHunter.DBInfo}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{CRISPRofftargetHunter.var"#35#37"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, CRISPRofftargetHunter.DBInfo}}, Array{Base.UnitRange{Int64}, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#35#37"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, CRISPRofftargetHunter.DBInfo}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{Base.UnitRange{Int64}, 1, Array{Base.UnitRange{Int64}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#35#37"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, CRISPRofftargetHunter.DBInfo}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#35#37"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, CRISPRofftargetHunter.DBInfo}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#36#38"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, CRISPRofftargetHunter.DBInfo}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{CRISPRofftargetHunter.var"#36#38"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, CRISPRofftargetHunter.DBInfo}}, Array{Base.UnitRange{Int64}, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#36#38"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, CRISPRofftargetHunter.DBInfo}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{Base.UnitRange{Int64}, 1, Array{Base.UnitRange{Int64}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#36#38"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, CRISPRofftargetHunter.DBInfo}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#36#38"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, CRISPRofftargetHunter.DBInfo}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#156#159"{Base.UnitRange{Int64}}, Array{Base.UnitRange{Int64}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{Base.UnitRange{Int64}, 1}, Base.Generator{Array{Base.UnitRange{Int64}, 1}, CRISPRofftargetHunter.var"#156#159"{Base.UnitRange{Int64}}}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#36#38"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, CRISPRofftargetHunter.DBInfo}, Array{Base.UnitRange{Int64}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{Base.UnitRange{Int64}, 1}, Base.Generator{Array{Base.UnitRange{Int64}, 1}, CRISPRofftargetHunter.var"#36#38"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, CRISPRofftargetHunter.DBInfo}}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#39#43"{CRISPRofftargetHunter.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64}, Array{Int64, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{Int64, 1}, Base.Generator{Array{Int64, 1}, CRISPRofftargetHunter.var"#39#43"{CRISPRofftargetHunter.DBInfo, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64}}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#162#164"{CRISPRofftargetHunter.VcfDB}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, CRISPRofftargetHunter.var"#162#164"{CRISPRofftargetHunter.VcfDB}}})
precompile(Tuple{typeof(Base._similar_for), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Type{Base.BitArray{1}}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, CRISPRofftargetHunter.var"#162#164"{CRISPRofftargetHunter.VcfDB}}, Base.HasShape{1}})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Base.BitArray{1}, 1}, Base.BitArray{1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, CRISPRofftargetHunter.var"#162#164"{CRISPRofftargetHunter.VcfDB}}, Int64})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#74#76"{String, Int64, FASTX.FASTA.Reader{TranscodingStreams.TranscodingStream{TranscodingStreams.Noop, Base.IOStream}}, CRISPRofftargetHunter.DBInfo}, Array{String, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{String, 1}, Base.Generator{Array{String, 1}, CRISPRofftargetHunter.var"#74#76"{String, Int64, FASTX.FASTA.Reader{TranscodingStreams.TranscodingStream{TranscodingStreams.Noop, Base.IOStream}}, CRISPRofftargetHunter.DBInfo}}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#47#50"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{CRISPRofftargetHunter.var"#47#50"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}}, Array{Base.UnitRange{Int64}, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#47#50"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{Base.UnitRange{Int64}, 1, Array{Base.UnitRange{Int64}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#47#50"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#47#50"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Base.UnitRange{Int64}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#48#51"{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{CRISPRofftargetHunter.Loc{UInt8, UInt32}, 1}}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{CRISPRofftargetHunter.var"#48#51"{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{CRISPRofftargetHunter.Loc{UInt8, UInt32}, 1}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#48#51"{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{CRISPRofftargetHunter.Loc{UInt8, UInt32}, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#48#51"{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{CRISPRofftargetHunter.Loc{UInt8, UInt32}, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{CRISPRofftargetHunter.PrefixDB, 1}, Array{CRISPRofftargetHunter.PrefixDB, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#48#51"{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{CRISPRofftargetHunter.Loc{UInt8, UInt32}, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{CRISPRofftargetHunter.PrefixDB, 1}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#53#58", Array{CRISPRofftargetHunter.PrefixDB, 1}})
precompile(Tuple{typeof(ThreadsX.collect), Base.Generator{Array{CRISPRofftargetHunter.PrefixDB, 1}, CRISPRofftargetHunter.var"#53#58"}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#53#58"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{CRISPRofftargetHunter.PrefixDB, 1, Array{CRISPRofftargetHunter.PrefixDB, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#53#58"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#53#58"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(ThreadsX.Implementations.reshape_as), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{CRISPRofftargetHunter.PrefixDB, 1}, CRISPRofftargetHunter.var"#53#58"}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#54#59", Array{CRISPRofftargetHunter.PrefixDB, 1}})
precompile(Tuple{typeof(ThreadsX.collect), Base.Generator{Array{CRISPRofftargetHunter.PrefixDB, 1}, CRISPRofftargetHunter.var"#54#59"}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#54#59"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{CRISPRofftargetHunter.PrefixDB, 1, Array{CRISPRofftargetHunter.PrefixDB, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#54#59"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#54#59"}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(ThreadsX.Implementations.reshape_as), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{CRISPRofftargetHunter.PrefixDB, 1}, CRISPRofftargetHunter.var"#54#59"}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#55#60"{String, String, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{CRISPRofftargetHunter.PrefixDB, 1}, Array{CRISPRofftargetHunter.PrefixDB, 1}}})
precompile(Tuple{typeof(Base.isbits), Any})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{CRISPRofftargetHunter.var"#55#60"{String, String, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{CRISPRofftargetHunter.PrefixDB, 1}, Array{CRISPRofftargetHunter.PrefixDB, 1}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#55#60"{String, String, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{CRISPRofftargetHunter.PrefixDB, 1}, Array{CRISPRofftargetHunter.PrefixDB, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
...
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#55#60"{String, String, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{CRISPRofftargetHunter.PrefixDB, 1}, Array{CRISPRofftargetHunter.PrefixDB, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Nothing, 1}, Array{Nothing, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#55#60"{String, String, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Array{CRISPRofftargetHunter.PrefixDB, 1}, Array{CRISPRofftargetHunter.PrefixDB, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Nothing, 1}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#75#77"{String, CRISPRofftargetHunter.DBInfo}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{CRISPRofftargetHunter.var"#75#77"{String, CRISPRofftargetHunter.DBInfo}}, Base.Set{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#75#77"{String, CRISPRofftargetHunter.DBInfo}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{SplittablesBase.Implementations.DictView{Base.Dict{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Nothing}, typeof(Base.first)}, Int64}}})
...
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#75#77"{String, CRISPRofftargetHunter.DBInfo}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Nothing, 1}, Array{Nothing, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#75#77"{String, CRISPRofftargetHunter.DBInfo}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Nothing, 1}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#83#88"{String, String, Int64, CRISPRofftargetHunter.LinearDB}})
precompile(Tuple{Type{NamedTuple{(:init, :basesize), T} where T<:Tuple}, Tuple{InitialValues.InitialValueOf{typeof(Base.:(+))}, Int64}})
precompile(Tuple{Transducers.var"#foldxt##kw", NamedTuple{(:init, :basesize), Tuple{InitialValues.InitialValueOf{typeof(Base.:(+))}, Int64}}, typeof(Transducers.foldxt), typeof(Base.:(+)), Transducers.Map{CRISPRofftargetHunter.var"#83#88"{String, String, Int64, CRISPRofftargetHunter.LinearDB}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#83#88"{String, String, Int64, CRISPRofftargetHunter.LinearDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, InitialValues.InitialValueOf{typeof(Base.:(+))}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#78#80"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64, Int64}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, CRISPRofftargetHunter.var"#78#80"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64, Int64}}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#79#81", Array{CRISPRofftargetHunter.PrefixAlignment{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{CRISPRofftargetHunter.PrefixAlignment{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, 1}, Base.Generator{Array{CRISPRofftargetHunter.PrefixAlignment{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, 1}, CRISPRofftargetHunter.var"#79#81"}})
...
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#83#88"{String, String, Int64, CRISPRofftargetHunter.LinearDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, Array{Int64, 2}, Array{Int64, 2}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#83#88"{String, String, Int64, CRISPRofftargetHunter.LinearDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, Array{Int64, 2}})
precompile(Tuple{typeof(Transducers.unreduced), Array{Int64, 2}})
precompile(Tuple{Base.var"##open#317", Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), CRISPRofftargetHunter.var"#84#89"{String}, String, Vararg{String, N} where N})
precompile(Tuple{Base.var"##open#317", Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), CRISPRofftargetHunter.var"#86#91"{Base.IOStream}, String, Vararg{String, N} where N})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#64#69"{CRISPRofftargetHunter.DictDB}, Array{String, 1}})
precompile(Tuple{typeof(ThreadsX.sum), Base.Generator{Array{String, 1}, CRISPRofftargetHunter.var"#64#69"{CRISPRofftargetHunter.DictDB}}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#64#69"{CRISPRofftargetHunter.DictDB}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}}, InitialValues.InitialValueOf{typeof(Base.add_sum)}, Transducers.CancellableDACContext, Transducers.SizedReducible{Base.SubArray{String, 1, Array{String, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Base.add_sum), InitialValues.InitialValueOf{typeof(Base.add_sum)}, Int64})
precompile(Tuple{typeof(Transducers._foldl_linear_bulk), Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.NoComplete, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#64#69"{CRISPRofftargetHunter.DictDB}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}}}, Int64, Base.SubArray{String, 1, Array{String, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64})
precompile(Tuple{typeof(Transducers.next), Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.NoComplete, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#64#69"{CRISPRofftargetHunter.DictDB}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}}}, Int64, String})
precompile(Tuple{typeof(Base.add_sum), Int64, Int64})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.NoComplete, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#64#69"{CRISPRofftargetHunter.DictDB}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}}}, Int64})
precompile(Tuple{typeof(Transducers.AutoObjectsReStacker.restack), Int64})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#64#69"{CRISPRofftargetHunter.DictDB}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}}, Int64, Int64})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#64#69"{CRISPRofftargetHunter.DictDB}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}, Int64})
precompile(Tuple{typeof(Transducers.unreduced), Int64})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#65#70"{CRISPRofftargetHunter.DictDB}, Array{String, 1}})
precompile(Tuple{typeof(ThreadsX.sum), Base.Generator{Array{String, 1}, CRISPRofftargetHunter.var"#65#70"{CRISPRofftargetHunter.DictDB}}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#65#70"{CRISPRofftargetHunter.DictDB}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}}, InitialValues.InitialValueOf{typeof(Base.add_sum)}, Transducers.CancellableDACContext, Transducers.SizedReducible{Base.SubArray{String, 1, Array{String, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers._foldl_linear_bulk), Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.NoComplete, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#65#70"{CRISPRofftargetHunter.DictDB}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}}}, Int64, Base.SubArray{String, 1, Array{String, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.NoComplete, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#65#70"{CRISPRofftargetHunter.DictDB}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}}}, Int64})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#65#70"{CRISPRofftargetHunter.DictDB}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}}, Int64, Int64})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#65#70"{CRISPRofftargetHunter.DictDB}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}, Int64})
...
precompile(Tuple{typeof(Transducers.next), Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.NoComplete, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#65#70"{CRISPRofftargetHunter.DictDB}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}}}, Int64, String})
...
precompile(Tuple{typeof(BioSequences.n_ambiguous), BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#136#139"{CRISPRofftargetHunter.BinDB{UInt8}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(ThreadsX.sum), Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, CRISPRofftargetHunter.var"#136#139"{CRISPRofftargetHunter.BinDB{UInt8}}}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#136#139"{CRISPRofftargetHunter.BinDB{UInt8}}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}}, InitialValues.InitialValueOf{typeof(Base.add_sum)}, Transducers.CancellableDACContext, Transducers.SizedReducible{Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#136#139"{CRISPRofftargetHunter.BinDB{UInt8}}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}}, Int64, Int64})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#136#139"{CRISPRofftargetHunter.BinDB{UInt8}}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}, Int64})
...
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#136#139"{CRISPRofftargetHunter.BinDB{UInt8}}}, Transducers.Reduction{Transducers.Map{typeof(Base.identity)}, Transducers.BottomRF{Transducers.Completing{typeof(Base.add_sum)}}}}, UInt64})
...
precompile(Tuple{typeof(ThreadsX.findfirst), Function, Array{UInt64, 1}})
precompile(Tuple{ThreadsX.Implementations.var"##findfirst#32", Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(ThreadsX.findfirst), CRISPRofftargetHunter.var"#148#152"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, Array{UInt64, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.ReduceIf{ThreadsX.Implementations.var"#33#34"{CRISPRofftargetHunter.var"#148#152"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, Array{UInt64, 1}}}, Transducers.BottomRF{Transducers.Completing{typeof(Transducers.right)}}}}, Nothing, Transducers.CancellableDACContext, Transducers.SizedReducible{Base.SubArray{Int64, 1, Base.LinearIndices{1, Tuple{Base.OneTo{Int64}}}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{typeof(Transducers.unreduced), Transducers.Reduced{Int64}})
precompile(Tuple{typeof(ThreadsX.findall), Function, Array{UInt64, 1}})
precompile(Tuple{ThreadsX.Implementations.var"##findall#42", Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(ThreadsX.findall), CRISPRofftargetHunter.var"#149#153"{Int64, CRISPRofftargetHunter.NoHashDB, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, Array{UInt64, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.Filter{ThreadsX.Implementations.var"#43#44"{CRISPRofftargetHunter.var"#149#153"{Int64, CRISPRofftargetHunter.NoHashDB, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, Array{UInt64, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{Int64, 1, Base.LinearIndices{1, Tuple{Base.OneTo{Int64}}}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
...
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Filter{ThreadsX.Implementations.var"#43#44"{CRISPRofftargetHunter.var"#149#153"{Int64, CRISPRofftargetHunter.NoHashDB, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, Array{UInt64, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Int64, 1}})
precompile(Tuple{Type{Base.Set{T} where T}, Int64})
...
precompile(Tuple{typeof(Transducers.combine_right_reduced), Function, Int64, Transducers.Reduced{Int64}})
precompile(Tuple{typeof(Transducers.combine), typeof(Transducers.right), Int64, Int64})
precompile(Tuple{typeof(Transducers.reduced), Int64})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#114#115"{String, Int64, FASTX.FASTA.Reader{TranscodingStreams.TranscodingStream{TranscodingStreams.Noop, Base.IOStream}}, CRISPRofftargetHunter.DBInfo}, Array{String, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{String, 1}, Base.Generator{Array{String, 1}, CRISPRofftargetHunter.var"#114#115"{String, Int64, FASTX.FASTA.Reader{TranscodingStreams.TranscodingStream{TranscodingStreams.Noop, Base.IOStream}}, CRISPRofftargetHunter.DBInfo}}})
precompile(Tuple{typeof(Base._similar_for), Array{String, 1}, Type{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}}, Base.Generator{Array{String, 1}, CRISPRofftargetHunter.var"#114#115"{String, Int64, FASTX.FASTA.Reader{TranscodingStreams.TranscodingStream{TranscodingStreams.Noop, Base.IOStream}}, CRISPRofftargetHunter.DBInfo}}, Base.HasShape{1}})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, 1}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{String, 1}, CRISPRofftargetHunter.var"#114#115"{String, Int64, FASTX.FASTA.Reader{TranscodingStreams.TranscodingStream{TranscodingStreams.Noop, Base.IOStream}}, CRISPRofftargetHunter.DBInfo}}, Int64})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#110#112"{Array{UInt32, 1}, Int64, Int64}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{CRISPRofftargetHunter.var"#110#112"{Array{UInt32, 1}, Int64, Int64}}, Array{Int64, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#110#112"{Array{UInt32, 1}, Int64, Int64}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.CancellableDACContext, Transducers.SizedReducible{Base.SubArray{Int64, 1, Array{Int64, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
...
precompile(Tuple{typeof(Transducers._foldl_linear_bulk), Transducers.Reduction{Transducers.NoComplete, Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#110#112"{Array{UInt32, 1}, Int64, Int64}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}}, Array{Int64, 1}, Base.SubArray{Int64, 1, Array{Int64, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64})
precompile(Tuple{typeof(Transducers.AutoObjectsReStacker.restack), Array{Int64, 1}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#110#112"{Array{UInt32, 1}, Int64, Int64}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Int64, 1}, Array{Int64, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#110#112"{Array{UInt32, 1}, Int64, Int64}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{Int64, 1}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#110#112"{Array{UInt32, 1}, Int64, Int64}, Array{Int64, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{Int64, 1}, Base.Generator{Array{Int64, 1}, CRISPRofftargetHunter.var"#110#112"{Array{UInt32, 1}, Int64, Int64}}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#111#113"{Array{UInt8, 1}, Array{UInt32, 1}, Array{UInt32, 1}}})
precompile(Tuple{Transducers.var"#tcollect##kw", NamedTuple{(:basesize,), Tuple{Int64}}, typeof(Transducers.tcollect), Transducers.Map{CRISPRofftargetHunter.var"#111#113"{Array{UInt8, 1}, Array{UInt32, 1}, Array{UInt32, 1}}}, Base.UnitRange{Int64}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#111#113"{Array{UInt8, 1}, Array{UInt32, 1}, Array{UInt32, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.UnitRange{Int64}, Int64}}})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#111#113"{Array{UInt8, 1}, Array{UInt32, 1}, Array{UInt32, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{CRISPRofftargetHunter.Node, 1}, Array{CRISPRofftargetHunter.Node, 1}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#111#113"{Array{UInt8, 1}, Array{UInt32, 1}, Array{UInt32, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}, Array{CRISPRofftargetHunter.Node, 1}})
...
precompile(Tuple{Type{Transducers.Map{F} where F}, CRISPRofftargetHunter.var"#119#124"{String, String, Int64, CRISPRofftargetHunter.TreeDB}})
precompile(Tuple{Transducers.var"#foldxt##kw", NamedTuple{(:init, :basesize), Tuple{InitialValues.InitialValueOf{typeof(Base.:(+))}, Int64}}, typeof(Transducers.foldxt), typeof(Base.:(+)), Transducers.Map{CRISPRofftargetHunter.var"#119#124"{String, String, Int64, CRISPRofftargetHunter.TreeDB}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#119#124"{String, String, Int64, CRISPRofftargetHunter.TreeDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, InitialValues.InitialValueOf{typeof(Base.:(+))}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#116#117"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64, Int64}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, CRISPRofftargetHunter.var"#116#117"{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64, Int64}}})
...
precompile(Tuple{typeof(Base.:(>)), Int64, UInt8})
precompile(Tuple{typeof(Transducers.combine), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#119#124"{String, String, Int64, CRISPRofftargetHunter.TreeDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, Array{Int64, 2}, Array{Int64, 2}})
precompile(Tuple{typeof(Transducers.complete), Transducers.Reduction{Transducers.Map{CRISPRofftargetHunter.var"#119#124"{String, String, Int64, CRISPRofftargetHunter.TreeDB}}, Transducers.BottomRF{Transducers.Completing{typeof(Base.:(+))}}}, Array{Int64, 2}})
precompile(Tuple{Base.var"##open#317", Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), CRISPRofftargetHunter.var"#120#125"{String}, String, Vararg{String, N} where N})
precompile(Tuple{Base.var"##open#317", Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), CRISPRofftargetHunter.var"#122#127"{Base.IOStream}, String, Vararg{String, N} where N})
...
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.Filter{ThreadsX.Implementations.var"#43#44"{CRISPRofftargetHunter.var"#94#96", Array{Base.UnitRange{UInt32}, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{Int64, 1, Base.LinearIndices{1, Tuple{Base.OneTo{Int64}}}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
...
precompile(Tuple{Base.var"##open#317", Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), CRISPRofftargetHunter.var"#102#106"{String}, String, Vararg{String, N} where N})
precompile(Tuple{Base.var"##open#317", Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), CRISPRofftargetHunter.var"#104#108"{Base.IOStream}, String, Vararg{String, N} where N})
...
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.EachStringIndex{String}, CRISPRofftargetHunter.var"#26#27"{String, String, typeof(CRISPRofftargetHunter.notX)}}})
precompile(Tuple{CRISPRofftargetHunter.var"#26#27"{String, String, typeof(CRISPRofftargetHunter.notX)}, Int64})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, Main.var"#2#3"{String}, Array{String, 1}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Array{String, 1}, Main.var"#2#3"{String}}})
