...
precompile(Tuple{typeof(Base.grow_to!), Base.Dict{Symbol, Any}, Tuple{Base.Pair{Symbol, String}, Base.Pair{Symbol, DataType}, Base.Pair{Symbol, CRISPRofftargetHunter.var"#164#165"}, Base.Pair{Symbol, Bool}}, Int64})
precompile(Tuple{Type{NamedTuple{(:help, :arg_type, :required, :range_tester), T} where T<:Tuple}, Tuple{String, DataType, Bool, CRISPRofftargetHunter.var"#164#165"}})
precompile(Tuple{typeof(Base.merge), NamedTuple{(), Tuple{}}, NamedTuple{(:help, :arg_type, :required, :range_tester), Tuple{String, DataType, Bool, CRISPRofftargetHunter.var"#164#165"}}})
precompile(Tuple{typeof(Base.pairs), NamedTuple{(:help, :arg_type, :required, :range_tester), Tuple{String, DataType, Bool, CRISPRofftargetHunter.var"#164#165"}}})
precompile(Tuple{typeof(Base.keys), Base.Iterators.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:help, :arg_type, :required, :range_tester), Tuple{String, DataType, Bool, CRISPRofftargetHunter.var"#164#165"}}}})
precompile(Tuple{Type{Base.Dict{Symbol, Any}}, Base.Iterators.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:help, :arg_type, :required, :range_tester), Tuple{String, DataType, Bool, CRISPRofftargetHunter.var"#164#165"}}}})
...
precompile(Tuple{CRISPRofftargetHunter.var"#164#165", String})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#154#157"{Base.UnitRange{Int64}}, Array{Base.UnitRange{Int64}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{Base.UnitRange{Int64}, 1}, Base.Generator{Array{Base.UnitRange{Int64}, 1}, CRISPRofftargetHunter.var"#154#157"{Base.UnitRange{Int64}}}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CRISPRofftargetHunter.var"#160#162"{CRISPRofftargetHunter.VcfDB}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, CRISPRofftargetHunter.var"#160#162"{CRISPRofftargetHunter.VcfDB}}})
precompile(Tuple{typeof(Base._similar_for), Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Type{Base.BitArray{1}}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, CRISPRofftargetHunter.var"#160#162"{CRISPRofftargetHunter.VcfDB}}, Base.HasShape{1}})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Base.BitArray{1}, 1}, Base.BitArray{1}, Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, CRISPRofftargetHunter.var"#160#162"{CRISPRofftargetHunter.VcfDB}}, Int64})
...
precompile(Tuple{ThreadsX.Implementations.var"##findall#42", Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(ThreadsX.findall), CRISPRofftargetHunter.var"#147#151"{Int64, CRISPRofftargetHunter.NoHashDB, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, Array{UInt64, 1}})
precompile(Tuple{Transducers.var"#163#164"{Transducers.Reduction{Transducers.UseSIMD{false}, Transducers.Reduction{Transducers.Filter{ThreadsX.Implementations.var"#43#44"{CRISPRofftargetHunter.var"#147#151"{Int64, CRISPRofftargetHunter.NoHashDB, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, Array{UInt64, 1}}}, Transducers.Reduction{Transducers.Map{Type{BangBang.NoBang.SingletonVector{T} where T}}, Transducers.BottomRF{Transducers.Completing{typeof(BangBang.append!!)}}}}}, BangBang.NoBang.Empty{Array{T, 1} where T}, Transducers.NoopDACContext, Transducers.SizedReducible{Base.SubArray{Int64, 1, Base.LinearIndices{1, Tuple{Base.OneTo{Int64}}}, Tuple{Base.UnitRange{Int64}}, true}, Int64}}})
