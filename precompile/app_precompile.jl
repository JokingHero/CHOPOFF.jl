...
precompile(Tuple{typeof(Base.:(var"==")), Base.Libc.RawFD, Base.Libc.RawFD})
...
precompile(Tuple{typeof(Base.:(var"==")), Array{UInt8, 1}, Array{UInt8, 1}})
...
precompile(Tuple{typeof(Base.:(var"==")), Array{Any, 1}, Array{Int64, 1}})
...
precompile(Tuple{typeof(Base.iterate), Array{Array{UInt8, 1}, 1}})
precompile(Tuple{typeof(CHOPOFF.FMIndexes.locateall), Array{UInt8, 1}, CHOPOFF.FMIndexes.FMIndex{2, UInt8}})
precompile(Tuple{typeof(Base.iterate), Array{Array{UInt8, 1}, 1}, Int64})
...
precompile(Tuple{typeof(Base.iterate), Combinatorics.Permutations{Array{UInt8, 1}}, NamedTuple{(:mp, :mp_state), Tuple{Combinatorics.MultiSetPermutations{Array{Int64, 1}}, Array{Int64, 1}}}})
precompile(Tuple{typeof(Base.vcat), Array{Int64, 1}, Array{Int64, 1}, Array{Int64, 1}})
...
precompile(Tuple{typeof(Base.Broadcast.instantiate), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, typeof(Base.first), Tuple{NTuple{25, Tuple{DataFrames.IntegerRefpool{Int64}, DataFrames.IntegerRefarray{Array{UInt8, 1}}}}}}})
precompile(Tuple{typeof(Base.copy), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, typeof(Base.first), Tuple{NTuple{25, Tuple{DataFrames.IntegerRefpool{Int64}, DataFrames.IntegerRefarray{Array{UInt8, 1}}}}}}})
...
precompile(Tuple{typeof(Base.Broadcast.instantiate), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, typeof(Base.last), Tuple{NTuple{25, Tuple{DataFrames.IntegerRefpool{Int64}, DataFrames.IntegerRefarray{Array{UInt8, 1}}}}}}})
precompile(Tuple{typeof(Base.copy), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, typeof(Base.last), Tuple{NTuple{25, Tuple{DataFrames.IntegerRefpool{Int64}, DataFrames.IntegerRefarray{Array{UInt8, 1}}}}}}})
...
precompile(Tuple{typeof(ThreadsX.foreach), CHOPOFF.Sassy.var"#30#35"{Int64, Bool, CHOPOFF.Motif, Base.ReentrantLock, Array{Array{CHOPOFF.Offtarget{T, K} where K<:Unsigned where T<:Unsigned, 1}, 1}, Array{Int64, 2}, Base.BitArray{1}, Array{Int64, 1}, Bool, CHOPOFF.DBInfo, CHOPOFF.Sassy.var"#28#33"{Bool}, Int64, String, Int64}, Base.Iterators.Enumerate{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}}})
...
precompile(Tuple{typeof(Base.lock), CHOPOFF.Sassy.var"#31#37"{CHOPOFF.Offtarget{UInt8, UInt32}, Int64, Array{Array{CHOPOFF.Offtarget{T, K} where K<:Unsigned where T<:Unsigned, 1}, 1}, Array{Int64, 2}, Base.BitArray{1}, Array{Int64, 1}, Bool}, Base.ReentrantLock})
precompile(Tuple{Transducers.var"#254#255"{Transducers.Reduction{Transducers.Map{CHOPOFF.Sassy.var"#30#35"{Int64, Bool, CHOPOFF.Motif, Base.ReentrantLock, Array{Array{CHOPOFF.Offtarget{T, K} where K<:Unsigned where T<:Unsigned, 1}, 1}, Array{Int64, 2}, Base.BitArray{1}, Array{Int64, 1}, Bool, CHOPOFF.DBInfo, CHOPOFF.Sassy.var"#28#33"{Bool}, Int64, String, Int64}}, Transducers.BottomRF{Transducers.Completing{typeof(ThreadsX.Implementations.return_nothing)}}}, Nothing, Transducers.CancellableDACContext, Transducers.SizedReducible{Base.Iterators.Zip{Tuple{Base.UnitRange{Int64}, Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}}}, Int64}}})
...
precompile(Tuple{typeof(Base.Broadcast.instantiate), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, typeof(Base.first), Tuple{NTuple{26, Tuple{DataFrames.IntegerRefpool{Int64}, DataFrames.IntegerRefarray{Array{UInt8, 1}}}}}}})
precompile(Tuple{typeof(Base.copy), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, typeof(Base.first), Tuple{NTuple{26, Tuple{DataFrames.IntegerRefpool{Int64}, DataFrames.IntegerRefarray{Array{UInt8, 1}}}}}}})
...
precompile(Tuple{typeof(Base.Broadcast.instantiate), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, typeof(Base.last), Tuple{NTuple{26, Tuple{DataFrames.IntegerRefpool{Int64}, DataFrames.IntegerRefarray{Array{UInt8, 1}}}}}}})
precompile(Tuple{typeof(Base.copy), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, typeof(Base.last), Tuple{NTuple{26, Tuple{DataFrames.IntegerRefpool{Int64}, DataFrames.IntegerRefarray{Array{UInt8, 1}}}}}}})
...
precompile(Tuple{Main.var"#mutate_suffix!#11", BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, Int64})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, Main.var"#14#16", Combinatorics.MultiSetPermutations{Array{Char, 1}}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Combinatorics.MultiSetPermutations{Array{Char, 1}}, Main.var"#14#16"}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, Main.var"#15#18"{Int64, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Main.var"#15#18"{Int64, BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}}}})
...
precompile(Tuple{typeof(Base.lock), CHOPOFF.Sassy.var"#31#37"{CHOPOFF.Offtarget{UInt8, UInt8}, Int64, Array{Array{CHOPOFF.Offtarget{T, K} where K<:Unsigned where T<:Unsigned, 1}, 1}, Array{Int64, 2}, Base.BitArray{1}, Array{Int64, 1}, Bool}, Base.ReentrantLock})
...
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Style, Axes, F, Args} where Args<:Tuple where F where Axes where Style<:Union{Nothing, Base.Broadcast.BroadcastStyle}}, Base.Broadcast.DefaultArrayStyle{1}, DataFrames.var"#105#106"{Main.var"#34#35"}, Tuple{DataFrames.DataFrameRows{DataFrames.DataFrame}}})
precompile(Tuple{typeof(Base.Broadcast.materialize), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, DataFrames.var"#105#106"{Main.var"#34#35"}, Tuple{DataFrames.DataFrameRows{DataFrames.DataFrame}}}})
...
precompile(Tuple{typeof(CHOPOFF.Sassy.search_sassy_impl), Array{Int64, 1}, Array{UInt8, 1}, Int64, Array{UInt8, 1}, Base.Val{4}, Base.Val{false}})
...
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Style, Axes, F, Args} where Args<:Tuple where F where Axes where Style<:Union{Nothing, Base.Broadcast.BroadcastStyle}}, Base.Broadcast.DefaultArrayStyle{1}, DataFrames.var"#105#106"{Main.var"#36#38"}, Tuple{DataFrames.DataFrameRows{DataFrames.DataFrame}}})
precompile(Tuple{typeof(Base.Broadcast.materialize), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, DataFrames.var"#105#106"{Main.var"#36#38"}, Tuple{DataFrames.DataFrameRows{DataFrames.DataFrame}}}})
...
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Style, Axes, F, Args} where Args<:Tuple where F where Axes where Style<:Union{Nothing, Base.Broadcast.BroadcastStyle}}, Base.Broadcast.DefaultArrayStyle{1}, DataFrames.var"#105#106"{Main.var"#37#39"}, Tuple{DataFrames.DataFrameRows{DataFrames.DataFrame}}})
precompile(Tuple{typeof(Base.Broadcast.materialize), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, DataFrames.var"#105#106"{Main.var"#37#39"}, Tuple{DataFrames.DataFrameRows{DataFrames.DataFrame}}}})
...
precompile(Tuple{typeof(Base._all), Main.var"#40#41", NTuple{6, UInt64}, Base.Colon})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, Main.var"#44#51", Array{Tuple{Int64, Int64}, 1}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Array{Tuple{Int64, Int64}, 1}, Main.var"#44#51"}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, Main.var"#45#52", Array{Int64, 1}})
precompile(Tuple{typeof(Base.any), Base.Generator{Array{Int64, 1}, Main.var"#45#52"}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, Main.var"#47#54", Array{Tuple{Int64, Int64}, 1}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Array{Tuple{Int64, Int64}, 1}, Main.var"#47#54"}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, Main.var"#48#55", Array{Int64, 1}})
precompile(Tuple{typeof(Base.any), Base.Generator{Array{Int64, 1}, Main.var"#48#55"}})
...
precompile(Tuple{typeof(Base.mapfoldl_impl), Base.var"#326#327"{Main.var"#60#66"{UInt64}}, typeof(Base.add_sum), Int64, Array{UInt64, 1}})
...
precompile(Tuple{typeof(Base.mapfoldl_impl), Base.var"#326#327"{Main.var"#61#67"{UInt8}}, typeof(Base.add_sum), Int64, Array{UInt8, 1}})
...
precompile(Tuple{typeof(Base.mapfoldl_impl), Base.var"#326#327"{Main.var"#62#68"{UInt32}}, typeof(Base.add_sum), Int64, Array{UInt32, 1}})
...
precompile(Tuple{typeof(Base.mapfoldl_impl), Base.var"#326#327"{Main.var"#63#69"{UInt8}}, typeof(Base.add_sum), Int64, Array{UInt8, 1}})
precompile(Tuple{typeof(Base.mapfoldl_impl), Base.var"#326#327"{Main.var"#64#70"{UInt8}}, typeof(Base.add_sum), Int64, Array{UInt8, 1}})
precompile(Tuple{typeof(Base.rand), Base.UnitRange{Int64}})
precompile(Tuple{typeof(Base.mapfoldl_impl), Base.var"#326#327"{Main.var"#65#71"{UInt8}}, typeof(Base.add_sum), Int64, Array{UInt8, 1}})
