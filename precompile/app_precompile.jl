...
precompile(Tuple{typeof(StaticArraysCore.convert_ntuple), Type{UInt64}, NTuple{4, Int64}})
...
precompile(Tuple{typeof(Base.grow_to!), Base.Dict{Symbol, Any}, Tuple{Pair{Symbol, String}, Pair{Symbol, DataType}, Pair{Symbol, CHOPOFF.var"#302#304"}, Pair{Symbol, String}}, Int64})
precompile(Tuple{typeof(Base.pairs), NamedTuple{(:default, :help, :arg_type, :range_tester), Tuple{String, String, DataType, CHOPOFF.var"#302#304"}}})
precompile(Tuple{typeof(Base.keys), Base.Pairs{Symbol, Any, NTuple{4, Symbol}, NamedTuple{(:default, :help, :arg_type, :range_tester), Tuple{String, String, DataType, CHOPOFF.var"#302#304"}}}})
precompile(Tuple{Type{Base.Dict{Symbol, Any}}, Base.Pairs{Symbol, Any, NTuple{4, Symbol}, NamedTuple{(:default, :help, :arg_type, :range_tester), Tuple{String, String, DataType, CHOPOFF.var"#302#304"}}}})
precompile(Tuple{CHOPOFF.var"#302#304", String})
precompile(Tuple{typeof(Base.grow_to!), Base.Dict{Symbol, Any}, Tuple{Pair{Symbol, String}, Pair{Symbol, DataType}, Pair{Symbol, CHOPOFF.var"#303#305"}, Pair{Symbol, String}}, Int64})
precompile(Tuple{typeof(Base.pairs), NamedTuple{(:default, :help, :arg_type, :range_tester), Tuple{String, String, DataType, CHOPOFF.var"#303#305"}}})
precompile(Tuple{typeof(Base.keys), Base.Pairs{Symbol, Any, NTuple{4, Symbol}, NamedTuple{(:default, :help, :arg_type, :range_tester), Tuple{String, String, DataType, CHOPOFF.var"#303#305"}}}})
precompile(Tuple{Type{Base.Dict{Symbol, Any}}, Base.Pairs{Symbol, Any, NTuple{4, Symbol}, NamedTuple{(:default, :help, :arg_type, :range_tester), Tuple{String, String, DataType, CHOPOFF.var"#303#305"}}}})
precompile(Tuple{CHOPOFF.var"#303#305", String})
...
precompile(Tuple{typeof(ThreadsX.foreach), CHOPOFF.var"#296#299"{Int64, CHOPOFF.Motif, Base.ReentrantLock, Array{Array{CHOPOFF.Offtarget{T, K} where K<:Unsigned where T<:Unsigned, 1}, 1}, Array{Int64, 2}, Base.BitArray{1}, Int64, CHOPOFF.DBInfo, Int64, String, Int64}, Base.Iterators.Enumerate{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}}})
precompile(Tuple{Type{CHOPOFF.Loc{T, K} where K<:Unsigned where T<:Unsigned}, UInt8, UInt32, Bool})
precompile(Tuple{typeof(CHOPOFF.insert_offtarget_sassy!), Array{CHOPOFF.Offtarget{T, K} where K<:Unsigned where T<:Unsigned, 1}, CHOPOFF.Offtarget{UInt8, UInt32}, Int64})
precompile(Tuple{Transducers.var"#254#255"{Transducers.Reduction{Transducers.Map{CHOPOFF.var"#296#299"{Int64, CHOPOFF.Motif, Base.ReentrantLock, Array{Array{CHOPOFF.Offtarget{T, K} where K<:Unsigned where T<:Unsigned, 1}, 1}, Array{Int64, 2}, Base.BitArray{1}, Int64, CHOPOFF.DBInfo, Int64, String, Int64}}, Transducers.BottomRF{Transducers.Completing{typeof(ThreadsX.Implementations.return_nothing)}}}, Nothing, Transducers.CancellableDACContext, Transducers.SizedReducible{Base.Iterators.Zip{Tuple{Base.UnitRange{Int64}, Base.SubArray{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1, Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}, Tuple{Base.UnitRange{Int64}}, true}}}, Int64}}})
...
precompile(Tuple{typeof(Base.mapfoldl_impl), Base.var"#326#327"{Main.var"#16#22"{UInt64}}, typeof(Base.add_sum), Int64, Array{UInt64, 1}})
...
precompile(Tuple{typeof(Base.mapfoldl_impl), Base.var"#326#327"{Main.var"#17#23"{UInt8}}, typeof(Base.add_sum), Int64, Array{UInt8, 1}})
...
precompile(Tuple{typeof(Base.mapfoldl_impl), Base.var"#326#327"{Main.var"#18#24"{UInt32}}, typeof(Base.add_sum), Int64, Array{UInt32, 1}})
...
precompile(Tuple{typeof(Base.mapfoldl_impl), Base.var"#326#327"{Main.var"#19#25"{UInt8}}, typeof(Base.add_sum), Int64, Array{UInt8, 1}})
precompile(Tuple{typeof(Base.mapfoldl_impl), Base.var"#326#327"{Main.var"#20#26"{UInt8}}, typeof(Base.add_sum), Int64, Array{UInt8, 1}})
precompile(Tuple{typeof(Base.rand), Base.UnitRange{Int64}})
precompile(Tuple{typeof(Base.mapfoldl_impl), Base.var"#326#327"{Main.var"#21#27"{UInt8}}, typeof(Base.add_sum), Int64, Array{UInt8, 1}})
