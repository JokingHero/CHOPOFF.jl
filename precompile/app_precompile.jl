...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, CHOPOFF.Sassy.var"#50#61"{Base.Val{4}, Int64}, Base.UnitRange{Int64}})
...
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.UnitRange{Int64}, CHOPOFF.Sassy.var"#50#61"{Base.Val{4}, Int64}}})
...
precompile(Tuple{typeof(ThreadsX.foreach), CHOPOFF.Sassy.var"#51#62"{Int64, Bool, Symbol, CHOPOFF.Motif, Array{UInt8, 1}, Array{CHOPOFF.Sassy.SassyWorkspace{4}, 1}, Array{Array{CHOPOFF.Offtarget{T, K} where K<:Unsigned where T<:Unsigned, 1}, 1}, Array{Int64, 2}, Array{Bool, 1}, Array{Int64, 1}, Bool, CHOPOFF.DBInfo, CHOPOFF.Sassy.var"#47#58"{CHOPOFF.Sassy.var"#47#48#59"}, Int64, Int64}, Base.Iterators.Enumerate{Array{BioSequences.LongSequence{BioSequences.DNAAlphabet{4}}, 1}}})
