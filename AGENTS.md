...
Local profiling runner, artifacts, guides, and human outputs live under ignored `test/local_human/`:
...
- `CHOPOFF_PROFILE_GUIDES`: defaults to `test/local_human/data/guides_for_tests.txt`
